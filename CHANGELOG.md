...
-   [return Dir3 from Transform::up and friends][11604]
...
-   [Add `Dir2::from_xy` and `Dir3::from_xyz`][10882]
-   [Implement `Neg` for `Dir2` and `Dir3`][11179]
-   [Add constants for `Dir2` and `Dir3`][11180]
-   [Add `approx` feature to `bevy_math`][11176]
-   [Add `libm` feature to `bevy_math`][11238]
-   [Add `new_and_length` method to `Dir2` and `Dir3`][11172]
...
-   [Support rotating `Dir3` by `Quat`][11649]
...
-   [Use Dir3 for gizmos.circle normal][11422]
