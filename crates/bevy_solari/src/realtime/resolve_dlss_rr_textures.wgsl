...
fn resolve_dlss_rr_textures(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    textureStore(specular_albedo, pixel_id, vec4(material_specular_reflectance(F0_dielectric, surface.material.base_color, surface.material.metallic, F_ab, 1.0), 0.0));
