...
use bevy_math::{
    Mat4, UVec2, UVec3, Vec2, Vec3, Vec3A, Vec3Swizzles, Vec4, Vec4Swizzles,
};
...
const VEC2_HALF: Vec2 = Vec2::from_array([0.5, 0.5]);
const VEC2_HALF_NEGATIVE_Y: Vec2 = Vec2::from_array([0.5, -0.5]);
...
const NDC_MIN: Vec2 = Vec2::from_array([-1.0, -1.0]);
const NDC_MAX: Vec2 = Vec2::from_array([1.0, 1.0]);
