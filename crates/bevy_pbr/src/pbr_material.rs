...
pub struct StandardMaterial {
    ...
    /// - Screen-space specular transmission is rendered before alpha blending. Materials using
    ///   [`AlphaMode::Blend`], [`AlphaMode::Premultiplied`], [`AlphaMode::Add`], or
    ///   [`AlphaMode::Multiply`] do not use this effect, and will not be visible through specular
