...
@group(1) @binding(10) var diffuse_denoised_temporal: texture_storage_2d<rgba16float, read_write>;
@group(1) @binding(11) var diffuse_denoised_spatiotemporal: texture_storage_2d<rgba16float, read_write>;
