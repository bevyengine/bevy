...
@group(1) @binding(1) var noise: texture_2d_array<f32>;
@group(1) @binding(2) var previous_depth_buffer: texture_depth_2d;
@group(1) @binding(3) var depth_buffer: texture_depth_2d;
@group(1) @binding(4) var normals_buffer: texture_2d<f32>;
@group(1) @binding(5) var motion_vectors: texture_2d<f32>;
@group(1) @binding(6) var screen_probes_history: texture_2d_array<f32>;
@group(1) @binding(7) var screen_probes: texture_storage_2d_array<rgba16float, read_write>;
@group(1) @binding(8) var screen_probes_confidence_history: texture_2d_array<u32>;
@group(1) @binding(9) var screen_probes_confidence: texture_storage_2d_array<r8uint, write>;
@group(1) @binding(10) var screen_probes_merge_buffer: texture_storage_2d_array<rgba16float, read_write>;
@group(1) @binding(11) var<storage, read_write> screen_probes_spherical_harmonics: array<SphericalHarmonicsPacked>;
@group(1) @binding(12) var diffuse_irradiance_output: texture_storage_2d<rgba16float, write>;
...
#endif
@group(1) @binding(15) var<storage, read_write> world_cache_irradiance: array<vec4<f32>, WORLD_CACHE_SIZE>;
@group(1) @binding(16) var<storage, read_write> world_cache_cell_data: array<WorldCacheCellData, WORLD_CACHE_SIZE>;
@group(1) @binding(17) var<storage, read_write> world_cache_active_cells_new_irradiance: array<vec3<f32>, WORLD_CACHE_SIZE>;
...
@group(1) @binding(22) var<storage, read_write> world_cache_active_cells_dispatch: vec3<u32>;
#endif
