...
use crate::{
    CascadeShadowConfig, Cascades, DirectionalLight, Material, MeshMaterial3dHandle, PointLight,
...
/// A component bundle for PBR entities with a [`Mesh3d`] and a [`MeshMaterial3dHandle<StandardMaterial>`].
#[deprecated(
    since = "0.15.0",
    note = "Use the `Mesh3d` and `MeshMaterial3dHandle` components instead. Inserting them will now also insert the other components required by them automatically."
)]
pub type PbrBundle = MaterialMeshBundle<StandardMaterial>;

/// A component bundle for entities with a [`Mesh3d`] and a [`MeshMaterial3dHandle`].
#[derive(Bundle, Clone)]
#[deprecated(
    since = "0.15.0",
    note = "Use the `Mesh3d` and `MeshMaterial3dHandle` components instead. Inserting them will now also insert the other components required by them automatically."
