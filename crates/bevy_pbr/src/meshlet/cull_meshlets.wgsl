#import bevy_pbr::meshlet_bindings::{meshlet_thread_meshlet_ids, meshlets, get_meshlet_index, draw_command_buffer, draw_index_buffer, meshlet_thread_instance_ids, meshlet_instance_uniforms, meshlet_instance_material_ids, meshlet_bounding_spheres, view}
...
fn cull_meshlets(@builtin(global_invocation_id) thread_id: vec3<u32>) {
    ...
    if meshlet_visible {
        ...
        let draw_command = &draw_command_buffer[material_id];
