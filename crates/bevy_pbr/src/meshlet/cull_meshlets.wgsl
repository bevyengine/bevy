...
fn cull_meshlets(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    if meshlet_visible {
        ...
        let packed_instanced_meshlet_index = instanced_meshlet_index << 8u;
        ...
        for (var offset = 0u; offset < meshlet_index_count; offset++) {
            ...
            draw_index_buffer[draw_index_buffer_start + offset] = packed_instanced_meshlet_index | meshlet_index;
        }
    }
}
