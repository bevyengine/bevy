...
pub struct MeshMaterial3d<M: BevyMaterial>(pub Handle<M>);

impl<M: BevyMaterial> Default for MeshMaterial3d<M> {
    fn default() -> Self {
        Self(Handle::default())
    }
}

impl<M: BevyMaterial> PartialEq for MeshMaterial3d<M> {
    fn eq(&self, other: &Self) -> bool {
        self.0 == other.0
    }
}

impl<M: BevyMaterial> Eq for MeshMaterial3d<M> {}

impl<M: BevyMaterial> From<MeshMaterial3d<M>> for AssetId<M> {
...
impl<M: BevyMaterial> AsAssetId for MeshMaterial3d<M> {
    type Asset = M;
