...
pub fn init_prepass_view_bind_group(
    ...
    let empty_bind_group = render_device.create_bind_group(
        ...
        &pipeline_cache.get_bind_group_layout(pipeline.empty_layout.clone()),
        &[],
    );
...
pub fn prepare_prepass_view_bind_group(
    ...
    if let (Some(view_binding), Some(globals_binding), Some(visibility_ranges_buffer)) = (
        ...
        prepass_view_bind_group.no_motion_vectors = Some(
            render_device.create_bind_group(
                "prepass_view_no_motion_vectors_bind_group",
                &pipeline_cache
                    .get_bind_group_layout(prepass_pipeline.view_layout_no_motion_vectors.clone()),
        ...
        if let Some(previous_view_uniforms_binding) = previous_view_uniforms.uniforms.binding() {
            prepass_view_bind_group.motion_vectors = Some(
                render_device.create_bind_group(
                    "prepass_view_motion_vectors_bind_group",
                    &pipeline_cache
                        .get_bind_group_layout(prepass_pipeline.view_layout_motion_vectors.clone()),
                    &BindGroupEntries::with_indices((
                        (0, view_binding),
                        (1, globals_binding),
