...
use crate::{
    ...
    setup_morph_and_skinning_defs, skin, BevyMaterial, DeferredDrawFunction,
    DeferredFragmentShader, DeferredVertexShader, DrawMesh, EntitySpecializationTicks,
    ErasedMaterialPipelineKey, MaterialPipeline, MaterialProperties, MeshLayouts, MeshPipeline,
    MeshPipelineKey, OpaqueRendererMethod, PreparedMaterial, PrepassDrawFunction,
    PrepassFragmentShader, PrepassVertexShader, RenderLightmaps, RenderMaterialInstances,
...
pub struct PrepassEnabled<M: BevyMaterial>(PhantomData<M>);

impl<M: BevyMaterial> Default for PrepassEnabled<M> {
    fn default() -> Self {
