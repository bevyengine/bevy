...
/// # Usage Notes
///
/// * Spawn this component on an entity with a [`crate::MeshMaterial3d`] component holding a [`ForwardDecalMaterial`]. The alpha mode of base material should not be Opaque, Mask or AlphaToCoverage.
