...
fn point_light(
    ...
    let frag_to_light = light.position_radius.xyz - world_position.xyz;
    ...
    let closestPoint = frag_to_light + centerToRay * saturate(light.position_radius.w * inverseSqrt(dot(centerToRay, centerToRay)));
