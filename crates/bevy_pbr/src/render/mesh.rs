...
impl GetFullBatchData for MeshPipeline {
    ...
    fn get_index_and_compare_data(
        (mesh_instances, lightmaps, _, _, _, _, _): &SystemParamItem<Self::Param>,
...
pub struct MeshPhaseBindGroups {
    ...
    /// it.
    skinned: HashMap<SlabId, MeshBindGroupPair>,
...
pub struct MeshMorphTargetStorageKey {
    ...
    pub morph_target_slab_id: SlabId,
}
