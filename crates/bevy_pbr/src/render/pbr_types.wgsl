...
let STANDARD_MATERIAL_FLAGS_ALPHA_MODE_BITS: u32                = 448u; // (0b111 << 6)
let STANDARD_MATERIAL_FLAGS_ALPHA_MODE_OPAQUE: u32              = 0u;   // (0b000 << 6)
let STANDARD_MATERIAL_FLAGS_ALPHA_MODE_MASK: u32                = 64u;  // (0b001 << 6)
let STANDARD_MATERIAL_FLAGS_ALPHA_MODE_BLEND: u32               = 128u; // (0b010 << 6)
let STANDARD_MATERIAL_FLAGS_ALPHA_MODE_PREMULTIPLIED: u32       = 192u; // (0b011 << 6)
let STANDARD_MATERIAL_FLAGS_ALPHA_MODE_ADD: u32                 = 256u; // (0b100 << 6)
let STANDARD_MATERIAL_FLAGS_ALPHA_MODE_MULTIPLY: u32            = 320u; // (0b101 << 6)
