...
let STANDARD_MATERIAL_FLAGS_ALPHA_MODE_HASHED: u32              = 256u;
let STANDARD_MATERIAL_FLAGS_ALPHA_MODE_BLEND: u32               = 512u;
let STANDARD_MATERIAL_FLAGS_TWO_COMPONENT_NORMAL_MAP: u32       = 1024u;
let STANDARD_MATERIAL_FLAGS_FLIP_NORMAL_MAP_Y: u32              = 2048u;
