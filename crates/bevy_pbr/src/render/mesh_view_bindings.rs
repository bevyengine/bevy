...
pub fn prepare_mesh_view_bind_groups(
    ...
    (light_meta, global_light_meta): (Res<'_, LightMeta>, Res<'_, GlobalClusterableObjectMeta>),
    fog_meta: Res<'_, FogMeta>,
    (view_uniforms, environment_map_uniform): (
        Res<'_, ViewUniforms>,
        Res<'_, EnvironmentMapUniformBuffer>,
    ),
    views: Query<
        '_,
        '_,
    ...
    (images, mut fallback_images, fallback_image, fallback_image_zero): (
        Res<'_, RenderAssets<GpuImage>>,
        FallbackImageMsaa<'_>,
        Res<'_, FallbackImage>,
        Res<'_, FallbackImageZero>,
    ),
