...
fn sample_depth_map(
    parallax_depth_texture: texture_2d<f32>,
    parallax_depth_sampler: sampler,
    uv: vec2<f32>,
) -> f32 {
    ...
    return textureSampleLevel(
        parallax_depth_texture,
        parallax_depth_sampler,
        uv,
        0.0
    ).r;
}
...
fn parallaxed_uv(
    ...
    let pd = sample_depth_map(
        parallax_depth_texture,
        parallax_depth_sampler,
        previous_uv,
    );
    let previous_depth = pd - current_layer_depth + layer_depth;
