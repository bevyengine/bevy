...
impl MeshLayouts {
    ...
    pub fn model_only(
        ...
        render_device.create_bind_group(
            ...
            &pipeline_cache.get_bind_group_layout(self.model_only.clone()),
    ...
    pub fn lightmapped(
        ...
        if bindless_lightmaps {
            ...
            render_device.create_bind_group(
                ...
                &pipeline_cache.get_bind_group_layout(self.lightmapped.clone()),
                &[
                    entry::model(0, model.clone()),
    ...
    pub fn skinned(
        ...
        render_device.create_bind_group(
            ...
            &pipeline_cache.get_bind_group_layout(self.skinned.clone()),
            &[
                entry::model(0, model.clone()),
    ...
    pub fn skinned_motion(
        ...
        render_device.create_bind_group(
            ...
            &pipeline_cache.get_bind_group_layout(self.skinned_motion.clone()),
            &[
                entry::model(0, model.clone()),
                entry::skinning(render_device, 1, current_skin),
    ...
    pub fn morphed(
        ...
        render_device.create_bind_group(
            ...
            &pipeline_cache.get_bind_group_layout(self.morphed.clone()),
            &[
                entry::model(0, model.clone()),
    ...
    pub fn morphed_motion(
        ...
        render_device.create_bind_group(
            ...
            &pipeline_cache.get_bind_group_layout(self.morphed_motion.clone()),
            &[
                entry::model(0, model.clone()),
                entry::weights(2, current_weights),
                entry::targets(3, targets),
    ...
    pub fn morphed_skinned(
        ...
        render_device.create_bind_group(
            ...
            &pipeline_cache.get_bind_group_layout(self.morphed_skinned.clone()),
            &[
                entry::model(0, model.clone()),
                entry::skinning(render_device, 1, current_skin),
                entry::weights(2, current_weights),
    ...
    pub fn morphed_skinned_motion(
        ...
        render_device.create_bind_group(
            ...
            &pipeline_cache.get_bind_group_layout(self.morphed_skinned_motion.clone()),
            &[
                entry::model(0, model.clone()),
                entry::skinning(render_device, 1, current_skin),
                entry::weights(2, current_weights),
