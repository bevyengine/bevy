...
pub fn prepare_lights(
    ...
    for (entity, extracted_views, clusters, maybe_layers) in sorted_cameras
        .0
        .iter()
        .filter_map(|sorted_camera| views.get(sorted_camera.entity).ok())
    {
        ...
        let is_orthographic = extracted_views.views[0].clip_from_view.w_axis.w == 1.0;
        ...
        let mut gpu_lights = GpuLights {
            ...
            cluster_factors: Vec4::new(
                clusters.dimensions.x as f32 / extracted_views.viewport.z as f32,
                clusters.dimensions.y as f32 / extracted_views.viewport.w as f32,
