use crate::{
    ...
    DirectionalLightShadowMap, GlobalVisiblePointLights, MeshPipeline, PointLight,
    PointLightShadowMap, SpotLight, VisiblePointLights, SHADOW_SHADER_HANDLE,
};
...
use bevy_render::{
    ...
    render_phase::{
        ...
        EntityRenderCommand, PhaseItem, RenderCommandResult, RenderPhase, TrackedRenderPass,
    },
    render_resource::*,
