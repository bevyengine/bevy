...
@group(0) @binding(12) var<uniform> environment_map_index: i32;

@group(0) @binding(13) var screen_space_ambient_occlusion_texture: texture_2d<f32>;

#ifdef NO_ARRAY_TEXTURES_SUPPORT
@group(0) @binding(14) var environment_map_diffuse: texture_cube<f32>;
@group(0) @binding(15) var environment_map_specular: texture_cube<f32>;
#else
@group(0) @binding(14) var environment_map_diffuse: texture_cube_array<f32>;
@group(0) @binding(15) var environment_map_specular: texture_cube_array<f32>;
#endif
@group(0) @binding(16) var environment_map_sampler: sampler;

@group(0) @binding(17) var dt_lut_texture: texture_3d<f32>;
@group(0) @binding(18) var dt_lut_sampler: sampler;

#ifdef MULTISAMPLED
@group(0) @binding(19) var depth_prepass_texture: texture_depth_multisampled_2d;
@group(0) @binding(20) var normal_prepass_texture: texture_multisampled_2d<f32>;
@group(0) @binding(21) var motion_vector_prepass_texture: texture_multisampled_2d<f32>;
#else
@group(0) @binding(19) var depth_prepass_texture: texture_depth_2d;
@group(0) @binding(20) var normal_prepass_texture: texture_2d<f32>;
@group(0) @binding(21) var motion_vector_prepass_texture: texture_2d<f32>;
@group(0) @binding(22) var deferred_prepass_texture: texture_2d<u32>;
#endif
