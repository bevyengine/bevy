...
@group(0) @binding(12) var<storage> irradiance_volume_data: types::IrradianceVolumeData;
@group(0) @binding(13) var<uniform> irradiance_volumes: types::IrradianceVolumes;
