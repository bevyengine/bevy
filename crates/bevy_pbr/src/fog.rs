...
/// Configures a [distance fog](https://en.wikipedia.org/wiki/Distance_fog) effect.
///
/// Objects appear progressively more covered in atmospheric haze the further away they are
