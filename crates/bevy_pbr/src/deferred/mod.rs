...
use crate::{
    EnvironmentMapLight, OldMeshPipelineKey, ShadowFilteringMethod, ViewFogUniformOffset,
...
impl SpecializedRenderPipeline for DeferredLightingLayout {
    ...
    fn specialize(&self, key: PipelineKey<Self::Key>) -> RenderPipelineDescriptor {
        let key = OldMeshPipelineKey::from_bits(key.0).unwrap();
        ...
        RenderPipelineDescriptor {
            ...
            fragment: Some(FragmentState {
                ...
                targets: vec![Some(ColorTargetState {
                    format: if key.contains(OldMeshPipelineKey::HDR) {
...
pub fn prepare_deferred_lighting_pipelines(
    ...
    {
        let mut view_key = OldMeshPipelineKey::from_hdr(view.hdr);
            ...
            if let Some(tonemapping) = tonemapping {
                ...
                view_key |= match tonemapping {
                    ...
                    Tonemapping::ReinhardLuminance => {
                        OldMeshPipelineKey::TONEMAP_METHOD_REINHARD_LUMINANCE
                    }
