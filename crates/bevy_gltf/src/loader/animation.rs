use gltf::{accessor::Iter, Node};
use smallvec::SmallVec;

use bevy_animation::{prelude::*, AnimationTargetId};
...
pub fn load_animation_paths(gltf: &gltf::Gltf) -> HashMap<usize, (usize, Vec<Name>)> {
...
fn paths_recur(
    ...
    path.push(super::node::node_name(&node));
