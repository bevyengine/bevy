...
async fn load_gltf<'a, 'b, 'c>(
    ...
    bevy_log::warn_once!("Starting from Bevy 0.18, all imported glTF models will be rotated by 180 degrees around the Y axis to align with Bevy's coordinate system.
