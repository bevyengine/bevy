...
mod tests {
    ...
    fn reflect_sample_curve() {
        ...
        let _: Box<dyn Reflect + Send + Sync> = Box::new(SampleCurve::new(Interval::UNIT, samples, foo).unwrap());
        let _: Box<dyn Reflect + Send + Sync> = Box::new(SampleCurve::new(Interval::UNIT, samples, bar).unwrap());
        let _: Box<dyn Reflect + Send + Sync> = Box::new(SampleCurve::new(Interval::UNIT, samples, baz).unwrap());
    }
    ...
    fn reflect_uneven_sample_curve() {
        ...
        let _: Box<dyn Reflect + Send + Sync> = Box::new(UnevenSampleCurve::new(keyframes, foo).unwrap());
        let _: Box<dyn Reflect + Send + Sync> = Box::new(UnevenSampleCurve::new(keyframes, bar).unwrap());
        let _: Box<dyn Reflect + Send + Sync> = Box::new(UnevenSampleCurve::new(keyframes, baz).unwrap());
    }
}
