...
mod tests {
    ...
    fn local_ray_cast_triangle_2d() {
        ...
        let ray = Ray2d::new(Vec2::new(-2.0, 1.0), Dir2::X);
        ...
        let ray = Ray2d::new(Vec2::new(0.5, 0.5), Dir2::NEG_Y);
        ...
        assert!(!triangle.intersects_local_ray(Ray2d::new(Vec2::new(1.0, -1.0), Dir2::NEG_Y)));

        // Hit distance exceeds max distance.
        let ray = Ray2d::new(Vec2::new(-1.0, 1.0), Dir2::X);
