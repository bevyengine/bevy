...
mod tests {
    ...
    fn local_ray_cast_capsule_2d() {
        ...
        let ray = Ray2d::new(Vec2::new(-2.0, 1.0 + circle_frac_pi_4_y), Dir2::X);
        ...
        let ray = Ray2d::new(Vec2::new(0.0, 1.0), Dir2::NEG_Y);
        let hit = capsule.local_ray_cast(ray, f32::MAX, false);
        ...
        let ray = Ray2d::new(Vec2::new(0.0, -1.0), Dir2::Y);
        let hit = capsule.local_ray_cast(ray, f32::MAX, false);
        assert_eq!(hit, Some(RayHit2d::new(3.0, Dir2::NEG_Y)));

        // Ray points away from the capsule.
        assert!(!capsule.intersects_local_ray(Ray2d::new(Vec2::new(0.0, 2.1), Dir2::Y)));

        // Hit distance exceeds max distance.
        let ray = Ray2d::new(Vec2::new(0.0, 2.6), Dir2::NEG_Y);
