...
pub trait PrimitiveRayCast2d {
    ...
    /// assert!(circle.intersects_local_ray(Ray2d::new(Vec2::new(-2.0, 0.0), Dir2::X)));
    /// assert!(!circle.intersects_local_ray(Ray2d::new(Vec2::new(0.0, 2.0), Dir2::X)));
    /// ```
    #[inline]
    ...
    /// # use bevy_math::prelude::*;
    /// #
    /// let ray = Ray2d::new(Vec2::new(-1.0, 0.0), Dir2::X);
    /// let circle = Circle::new(1.0);
    ...
    ///
    /// // Test for ray intersections.
    /// assert!(circle.intersects_ray(iso, Ray2d::new(Vec2::new(-2.0, 0.0), Dir2::X)));
    /// assert!(!circle.intersects_ray(iso, Ray2d::new(Vec2::new(0.0, 2.0), Dir2::X)));
    /// ```
    #[inline]
...
mod tests {
    ...
    fn ray_cast_2d() {
        ...
        let ray = Ray2d::new(Vec2::new(-1.0, SQRT_2 / 2.0), Dir2::X);
