...
mod tests {
    ...
    fn local_ray_cast_rectangle() {
        ...
        assert!(!rectangle.intersects_local_ray(Ray2d::new(Vec2::new(0.0, 2.0), Dir2::Y)));
        assert!(!rectangle.intersects_local_ray(Ray2d::new(Vec2::new(0.0, 1.0), Dir2::X)));
        assert!(!rectangle.intersects_local_ray(Ray2d::new(Vec2::new(0.0, -1.0), Dir2::X)));
        assert!(!rectangle.intersects_local_ray(Ray2d::new(Vec2::new(2.0, 0.0), Dir2::Y)));
        assert!(!rectangle.intersects_local_ray(Ray2d::new(Vec2::new(-2.0, 0.0), Dir2::Y)));
