...
mod tests {
    ...
    fn local_ray_cast_arc() {
        ...
        assert!(!arc.intersects_local_ray(Ray2d::new(Vec2::new(2.0, 0.25), Dir2::NEG_X)));
        assert!(!arc.intersects_local_ray(Ray2d::new(Vec2::new(0.0, 0.9), Dir2::NEG_Y)));
        assert!(!arc.intersects_local_ray(Ray2d::new(Vec2::new(0.0, 1.1), Dir2::Y)));

        // Ray hits the arc.
        assert!(arc.intersects_local_ray(Ray2d::new(Vec2::new(2.0, 0.75), Dir2::NEG_X)));
        assert!(arc.intersects_local_ray(Ray2d::new(Vec2::new(0.0, 0.9), Dir2::Y)));
        assert!(arc.intersects_local_ray(Ray2d::new(Vec2::new(0.0, 1.1), Dir2::NEG_Y)));
