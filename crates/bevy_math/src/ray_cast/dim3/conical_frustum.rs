...
mod tests {
    ...
    fn local_ray_cast_conical_frustum() {
        ...
        assert!(frustum.intersects_local_ray(Ray3d::new(Vec3::new(0.0, 0.9, 0.0), Vec3::Y)));
        assert!(frustum.intersects_local_ray(Ray3d::new(Vec3::new(0.5, 0.5, 0.0), Vec3::X)));

        // Ray points away from the frustum.
        assert!(!frustum.intersects_local_ray(Ray3d::new(Vec3::new(0.0, 1.1, 0.0), Vec3::Y)));
        assert!(!frustum.intersects_local_ray(Ray3d::new(Vec3::new(0.75, 0.5, 0.0), Vec3::X)));
