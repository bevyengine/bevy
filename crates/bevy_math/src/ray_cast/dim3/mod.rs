...
pub trait PrimitiveRayCast3d {
    ...
    /// #
    /// let ray = Ray3d::new(Vec3::new(-2.0, 0.0, 0.0), Dir3::X);
    ...
    /// assert!(sphere.intersects_local_ray(Ray3d::new(Vec3::new(-2.0, 0.0, 0.0), Dir3::X)));
    /// assert!(!sphere.intersects_local_ray(Ray3d::new(Vec3::new(0.0, 2.0, 0.0), Dir3::X)));
    /// ```
    #[inline]
    ...
    /// # use bevy_math::prelude::*;
    /// #
    /// let ray = Ray3d::new(Vec3::new(-1.0, 0.0, 0.0), Dir3::X);
    /// let sphere = Sphere::new(1.0);
    ...
    ///
    /// // Test for ray intersections.
    /// assert!(sphere.intersects_ray(iso, Ray3d::new(Vec3::new(-2.0, 0.0, 0.0), Dir3::X)));
    /// assert!(!sphere.intersects_ray(iso, Ray3d::new(Vec3::new(0.0, 2.0, 0.0), Dir3::X)));
    /// ```
    #[inline]
...
mod tests {
    ...
    fn ray_cast_3d() {
        ...
        let ray = Ray3d::new(Vec3::new(-1.0, SQRT_2 / 2.0, 0.0), Dir3::X);
