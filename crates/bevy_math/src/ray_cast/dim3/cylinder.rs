...
mod tests {
    ...
    fn local_ray_cast_cylinder() {
        ...
        assert!(cylinder.intersects_local_ray(Ray3d::new(Vec3::new(0.0, 0.9, 0.0), Dir3::Y)));
        assert!(cylinder.intersects_local_ray(Ray3d::new(Vec3::new(0.4, 0.9, 0.0), Dir3::X)));

        // Ray points away from the cylinder.
        assert!(!cylinder.intersects_local_ray(Ray3d::new(Vec3::new(0.0, 1.1, 0.0), Dir3::Y)));
        assert!(!cylinder.intersects_local_ray(Ray3d::new(Vec3::new(0.6, 1.1, 0.0), Dir3::X)));
