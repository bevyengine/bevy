...
mod tests {
    ...
    fn local_ray_cast_triangle_3d() {
        ...
        assert!(!triangle.intersects_local_ray(Ray3d::new(Vec3::new(0.6, 1.0, 0.0), Dir3::NEG_Y)));
