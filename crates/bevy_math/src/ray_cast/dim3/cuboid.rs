...
mod tests {
    ...
    fn local_ray_cast_cuboid() {
        ...
        assert!(!cuboid.intersects_local_ray(Ray3d::new(Vec3::new(0.0, 1.0, 0.0), Dir3::Y)));
        assert!(!cuboid.intersects_local_ray(Ray3d::new(Vec3::new(0.0, 1.0, 0.0), Dir3::X)));
        assert!(!cuboid.intersects_local_ray(Ray3d::new(Vec3::new(0.0, -1.0, 0.0), Dir3::X)));
        assert!(!cuboid.intersects_local_ray(Ray3d::new(Vec3::new(0.0, 1.0, 0.0), Dir3::Z)));
        assert!(!cuboid.intersects_local_ray(Ray3d::new(Vec3::new(0.0, -1.0, 0.0), Dir3::Z)));
        assert!(!cuboid.intersects_local_ray(Ray3d::new(Vec3::new(2.0, 0.0, 0.0), Dir3::Y)));
        assert!(!cuboid.intersects_local_ray(Ray3d::new(Vec3::new(-2.0, 0.0, 0.0), Dir3::Y)));
