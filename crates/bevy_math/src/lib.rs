...
pub mod prelude {
    ...
    pub use crate::{
        ...
        EulerRot, FloatExt as _, IRect, IVec2, IVec3, IVec4, Isometry2d, Isometry3d, Mat2, Mat3,
        Mat3A, Mat4, Quat, Ray2d, Ray3d, Rect, Rot2, StableInterpolate, URect, UVec2, UVec3, UVec4,
