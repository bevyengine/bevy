...
fn asset_processor_transforms_asset_with_meta() {
    ...
    asset: Process(
        processor: "bevy_asset::processor::process::LoadTransformAndSave<bevy_asset::tests::CoolTextLoader, bevy_asset::processing_tests::RootAssetTransformer<bevy_asset::processing_tests::asset_processor_transforms_asset_with_meta::AddText, bevy_asset::tests::CoolText>, bevy_asset::processing_tests::CoolTextSaver>",
        settings: (
            loader_settings: (),
