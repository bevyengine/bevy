...
/// A collection of unprocessed and processed [`AssetReader`](crate::io::AssetReader),
/// [`AssetWriter`](crate::io::AssetWriter), and [`AssetWatcher`] instances for a specific asset
/// source, identified by an [`AssetSourceId`].
