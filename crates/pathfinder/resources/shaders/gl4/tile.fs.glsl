...
layout(binding = 2) uniform sampler2D SPIRV_Cross_CombineduMaskTexture0uSampler;
layout(binding = 1) uniform sampler2D SPIRV_Cross_CombineduColorTexture0uSampler;
layout(binding = 4) uniform sampler2D SPIRV_Cross_CombineduGammaLUTuSampler;
layout(binding = 3) uniform sampler2D SPIRV_Cross_CombineduDestTextureuSampler;
