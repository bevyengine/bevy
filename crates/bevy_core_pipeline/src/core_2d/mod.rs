...
impl Plugin for Core2dPlugin {
    fn build(&self, app: &mut App) {
        ...
        render_app
            ...
            .add_system(extract_core_2d_camera_phases.in_set(RenderStage::Extract))
            .add_system(sort_phase_system::<Transparent2d>.in_set(RenderStage::PhaseSort))
            .add_system(
                batch_phase_system::<Transparent2d>
                    .after(sort_phase_system::<Transparent2d>.in_set(RenderStage::PhaseSort)),
            );
