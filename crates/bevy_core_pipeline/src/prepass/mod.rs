...
pub struct ViewPrepassTextures {
    ...
    /// The depth texture generated by the prepass from last frame.
    /// Exists only if [`DepthPrepass`] is added to the [`ViewTarget`](bevy_render::view::ViewTarget)
    /// and [`DepthPrepass::keep_last_frame_depth`] is true.
    pub last_frame_depth: Option<CachedTexture>,
    ...
    /// The normal texture generated by the prepass from last frame.
    /// Exists only if [`NormalPrepass`] is added to the [`ViewTarget`](bevy_render::view::ViewTarget)
    /// and [`NormalPrepass::keep_last_frame_normal`] is true.
    pub last_frame_normal: Option<CachedTexture>,
