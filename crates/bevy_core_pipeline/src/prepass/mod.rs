...
use bevy_render::texture::ColorAttachmentHandle;
use bevy_render::{
    render_phase::{
...
pub struct ViewPrepassTextures {
    ...
    pub depth: Option<ColorAttachmentHandle>,
