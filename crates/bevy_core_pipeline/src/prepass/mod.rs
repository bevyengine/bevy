//! Prepass before the main pass to generate depth, normals, and/or motion vectors textures.
//!
...
/// Vertex world normals will be copied to a
/// separate texture available to the main pass.
///
/// Normals will have normal map textures already
/// applied.
#[derive(Component, Default, Reflect, Clone)]
#[reflect(Component, Default)]
pub struct NormalPrepass;

/// Screen space motion vectors will be copied to a
/// separate texture available to the main pass.
#[derive(Component, Default, Reflect, Clone)]
#[reflect(Component, Default)]
pub struct MotionVectorPrepass;

/// Deferred materials will be rendered to the
/// deferred gbuffer texture and will be available to subsequent passes.
///
/// Note the default deferred
