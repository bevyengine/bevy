...
use bevy_render::texture::ColorAttachmentProvider;
use bevy_render::{
    render_phase::{
...
pub struct ViewPrepassTextures {
    ...
    pub depth: Option<ColorAttachmentProvider>,
