...
//!
//! To enable the prepass, you need to add a prepass component to a [`Camera`].
//!
//! [`PrepassDepth`]
//! [`PrepassNormal`]
//!
//! Both textures are available on the `PrepassTextures` component attached to each [`Camera`] with a prepass component.
