...
pub struct Bloom {
    ...
    /// Controls the threshold filter used for extracting the brightest regions from the input
    /// image before blurring them and compositing back onto the original image.
    ///
