...
pub const FXAA_SHADER_HANDLE: Handle<Shader> = Handle::weak_from_u128(4182761465141723543);
pub const FXAA_FUNCTIONS_SHADER_HANDLE: Handle<Shader> = Handle::weak_from_u128(914590283475021983);
