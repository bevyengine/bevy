...
impl Node for ClearPassNode {
    ...
    fn run(
        ...
        let clear_color = world.get_resource::<ClearColor>();
        let render_target_clear_colors = world.get_resource::<RenderTargetClearColors>();
        ...
        let images = world.get_resource::<RenderAssets<Image>>();
