...
impl ViewNode for DeferredGBufferPrepassNode {
    ...
    fn run<'w>(
        ...
        // If we clear the deferred texture with LoadOp::Clear(Default::default()) we get these
        // errors: Chrome: GL_INVALID_OPERATION: No defined conversion between clear value
        // and attachment format. Firefox: WebGL warning: clearBufferu?[fi]v: This
        // attachment is of type FLOAT, but this function is of type UINT. Appears to be unsupported: https://registry.khronos.org/webgl/specs/latest/2.0/#3.7.9
