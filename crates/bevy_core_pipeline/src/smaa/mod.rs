...
fn perform_edge_detection(
    ...
    render_pass.set_bind_group(0, Some(&postprocess_bind_group), &[**view_smaa_uniform_offset]);
    render_pass.set_bind_group(1, Some(&view_smaa_bind_groups.edge_detection_bind_group), &[]);
