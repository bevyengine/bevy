...
use bevy_ecs::{entity::Entity, prelude::StageConfig};
...
impl Plugin for TextPlugin {
    fn build(&self, app: &mut App) {
        app.add_asset::<Font>()
            ...
            .add_system(text2d_system.stage(CoreStage::PostUpdate))
            .add_system(text2d::draw_text2d_system.stage(RenderStage::Draw));
    }
}
