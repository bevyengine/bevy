...
//!
//! [`Text`] is first measured by creating a [`TextMeasureInfo`] in
...
//!
//! 1. creates a [`Buffer`](cosmic_text::Buffer) from the [`TextSection`]s, generating new
...
/// Orientation of text, which is used by different view projections.
///
