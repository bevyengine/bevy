...
/// Can be created via [`Device::create_render_pipeline`](crate::renderer::Device::create_render_pipeline).
#[derive(Clone, Debug)]
...
/// Can be created via [`Device::create_compute_pipeline`](crate::renderer::Device::create_compute_pipeline).
#[derive(Clone, Debug)]
