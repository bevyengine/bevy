...
pub fn create_bindless_bind_group_layout_entries(
    ...
    vec![
        ...
        .build(*bindless_index_table_binding_number, ShaderStages::FRAGMENT | ShaderStages::VERTEX | ShaderStages::COMPUTE),
        // Continue with the common bindless resource arrays.
        sampler(SamplerBindingType::Filtering)
            .count(bindless_slab_resource_limit)
            .build(1, ShaderStages::FRAGMENT | ShaderStages::VERTEX | ShaderStages::COMPUTE),
        sampler(SamplerBindingType::NonFiltering)
            .count(bindless_slab_resource_limit)
            .build(2, ShaderStages::FRAGMENT | ShaderStages::VERTEX | ShaderStages::COMPUTE),
        sampler(SamplerBindingType::Comparison)
            .count(bindless_slab_resource_limit)
            .build(3, ShaderStages::FRAGMENT | ShaderStages::VERTEX | ShaderStages::COMPUTE),
        texture_1d(TextureSampleType::Float { filterable: true })
            .count(bindless_slab_resource_limit)
            .build(4, ShaderStages::FRAGMENT | ShaderStages::VERTEX | ShaderStages::COMPUTE),
        texture_2d(TextureSampleType::Float { filterable: true })
            .count(bindless_slab_resource_limit)
            .build(5, ShaderStages::FRAGMENT | ShaderStages::VERTEX | ShaderStages::COMPUTE),
        texture_2d_array(TextureSampleType::Float { filterable: true })
            .count(bindless_slab_resource_limit)
            .build(6, ShaderStages::FRAGMENT | ShaderStages::VERTEX | ShaderStages::COMPUTE),
        texture_3d(TextureSampleType::Float { filterable: true })
            .count(bindless_slab_resource_limit)
            .build(7, ShaderStages::FRAGMENT | ShaderStages::VERTEX | ShaderStages::COMPUTE),
        texture_cube(TextureSampleType::Float { filterable: true })
            .count(bindless_slab_resource_limit)
            .build(8, ShaderStages::FRAGMENT | ShaderStages::VERTEX | ShaderStages::COMPUTE),
        texture_cube_array(TextureSampleType::Float { filterable: true })
            .count(bindless_slab_resource_limit)
            .build(9, ShaderStages::FRAGMENT | ShaderStages::VERTEX | ShaderStages::COMPUTE),
    ]
}
