...
use bevy_gpu::{
    Device, DynamicUniformBuffer, Extent3d, Operations, Queue, RawColor, RenderPassColorAttachment,
...
impl ViewTarget {
    ...
    pub fn get_color_attachment(&self, ops: Operations<RawColor>) -> RenderPassColorAttachment {
