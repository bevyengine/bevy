use super::{DepthCalculation, Camera};
...
fn world_to_screen_coordinate(world_space_coords: Vec3, camera: Camera, camera_position: GlobalTransform, window: &Window) -> Vec2 {
