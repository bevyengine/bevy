use crate::{
    ...
    frame_graph::{
        ColorAttachmentRef, FrameGraph, FrameGraphTexture, RenderPass, Setup, SetupGraphContext,
        SetupRunError, TextureViewInfo, TextureViewRef,
    },
...
pub struct CameraDriverSetup {
    cameras: QueryState<&'static ExtractedCamera>,
}

impl CameraDriverSetup {
...
impl Setup for CameraDriverSetup {
    ...
    fn run(
        ...
        let mut camera_windows: HashSet<Entity> = <HashSet<_>>::default();
