...
pub enum RenderSet {
    ...
    /// A sub-set within [`Prepare`](RenderSet::Prepare) for constructing bind groups, or other
    /// data that relies on render resources prepared in
...
/// Applies the commands from the extract schedule.
///
/// This happens during
