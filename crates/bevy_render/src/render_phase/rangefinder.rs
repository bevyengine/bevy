...
pub struct Rangefinder3d {
    view_from_world_row_2: Vec4,
}

impl Rangefinder3d {
    /// Creates a 3D rangefinder for a view matrix.
    pub fn from_world_from_view(world_from_view: &Mat4) -> Rangefinder3d {
...
#[cfg(test)]
mod tests {
    use super::Rangefinder3d;
    use bevy_math::{Mat4, Vec3};

    #[test]
    fn distance() {
        let view_matrix = Mat4::from_translation(Vec3::new(0.0, 0.0, -1.0));
        let rangefinder = Rangefinder3d::from_world_from_view(&view_matrix);
