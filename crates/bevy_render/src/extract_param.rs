...
/// ## Context
///
/// [`RenderSet::Extract`] is used to extract (move) data from the simulation world ([`MainWorld`]) to the
...
///
/// [`Extract`] is used to get data from the main world during [`RenderSet::Extract`].
///
/// ## Examples
///
/// ```rust
...
/// ```
///
/// [`RenderSet::Extract`]: crate::RenderSet::Extract
