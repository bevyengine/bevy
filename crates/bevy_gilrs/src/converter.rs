...
pub fn convert_button(button: gilrs::Button, code: gilrs::ev::Code) -> Option<GamepadButtonType> {
    match button {
        ...
        gilrs::Button::Unknown => Some(GamepadButtonType::Other(code)),
    }
}
...
pub fn convert_axis(axis: gilrs::Axis, code: gilrs::ev::Code) -> Option<GamepadAxisType> {
    match axis {
        ...
        gilrs::Axis::Unknown => Some(GamepadAxisType::Other(code)),
