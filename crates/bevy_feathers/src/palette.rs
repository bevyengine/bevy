...
/// <div style="background-color: #3498DB; width: 10px; padding: 10px; border: 1px solid;"></div> - for info messages and indicators
pub const INFO: Color = Color::oklcha(0.6531, 0.135, 242.69, 1.0);
/// <div style="background-color: #07BC0C; width: 10px; padding: 10px; border: 1px solid;"></div> - for success messages and indicators
pub const SUCCESS: Color = Color::oklcha(0.6896, 0.232, 142.64, 1.0);
/// <div style="background-color: #F1C40F; width: 10px; padding: 10px; border: 1px solid;"></div> - for warnings and cautionary indicators
pub const WARNING: Color = Color::oklcha(0.8358, 0.169, 91.77, 1.0);
/// <div style="background-color: #E74D3C; width: 10px; padding: 10px; border: 1px solid;"></div> - for error messages and indicators
pub const ERROR: Color = Color::oklcha(0.6318, 0.193, 29.71, 1.0);
