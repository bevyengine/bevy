...
static DEFAULT_TOKEN_SLOTS: &[(ThemeToken, Slot)] = &[
    ...
    (tokens::MENUITEM_BG_HOVER, Slot::Neutral3),
    ...
    (tokens::GROUP_HEADER_BG, Slot::Neutral2),
    (tokens::GROUP_HEADER_BORDER, Slot::Neutral2),
    (tokens::GROUP_HEADER_TEXT, Slot::Text0),
    (tokens::GROUP_BODY_BG, Slot::Neutral2),
    (tokens::GROUP_BODY_BORDER, Slot::Neutral2),
