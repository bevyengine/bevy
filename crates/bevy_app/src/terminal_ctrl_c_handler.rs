...
/// Gracefully handles `Ctrl+C` by emitting a [`AppExit`] event. This plugin is part of the
/// `DefaultPlugins`.
///
/// ```no_run
...
/// [`TerminalCtrlCHandlerPlugin::gracefully_exit`] function in your handler if you want bevy to
/// gracefully exit. ```no_run
