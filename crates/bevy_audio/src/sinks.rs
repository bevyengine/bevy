...
pub trait AudioSinkPlayback {
    ...
    ///
    /// An increase of 10 decibels (dB) roughly corresponds to the perceived volume doubling in
    /// intensity. As this function scales not the volume but the amplitude, a conversion might
    /// be necessary. For example, to halve the perceived volume you need to decrease the volume
    /// by 10 dB. This corresponds to 20log(x) = -10dB, solving x = 10^(-10/20) = 0.316.
