...
pub struct Window {
    ...
    /// Sets wether this window recognize [`PinchGesture`]
    ///
    /// ## Platform-specific
    ///
    /// - Only used on iOS.
    ...
    /// Sets wether this window recognize [`RotationGesture`]
    ///
    /// ## Platform-specific
    ///
    /// - Only used on iOS.
    ...
    /// Sets wether this window recognize [`DoubleTapGesture`]
    ///
    /// ## Platform-specific
    ///
    /// - Only used on iOS.
    ...
    /// Sets wether this window recognize [`PanGesture`], with a number of fingers between the first value and the last.
    ///
    /// ## Platform-specific
    ///
    /// - Only used on iOS.
