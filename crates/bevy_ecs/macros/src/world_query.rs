...
use quote::quote;
use syn::{Attribute, Fields, ImplGenerics, Member, TypeGenerics, Visibility, WhereClause};
    ...
    match fields {
        Fields::Named(_) => quote! {
            ...
            #visibility struct #item_struct_name #user_impl_generics_with_world #user_where_clauses_with_world {
                #(#(#field_attrs)* #field_visibilities #field_members: <#field_types as #path::query::QueryData>::Item<'__w>,)*
            }
        },
    ...
    quote! {
        ...
        unsafe impl #user_impl_generics #path::query::WorldQuery
            ...
            fn shrink_fetch<'__wlong: '__wshort, '__wshort>(
                ...
                #fetch_struct_name {
                    #(
                        #field_idents: <#field_types>::shrink_fetch(fetch.#field_idents),
                    )*
                    #marker_name: &(),
                }
            }
            ...
            fn get_state(components: &#path::component::Components) -> Option<#state_struct_name #user_ty_generics> {
                Some(#state_struct_name {
                    #(#field_idents: <#field_types>::get_state(components)?,)*
                })
            }
