...
impl DeriveComponent {
    ...
    pub fn impl_component(self, ast: &mut DeriveInput, bevy_ecs: &Path) -> Result<TokenStream> {
        ...
        let change_mode = change_mode_path(bevy_ecs, self.change_mode);
        ...
        Ok(quote! {
            ...
            impl #impl_generics #bevy_ecs::component::Component for #struct_name #type_generics #where_clause {
                ...
                const CHANGE_MODE: #bevy_ecs::component::ChangeMode = #change_mode;
...
fn change_mode_path(bevy_ecs_path: &Path, change_mode: ChangeMode) -> TokenStream {
