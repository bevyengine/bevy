...
fn main() {
    ...
    // The event registry is stored as a resource, and allows us to quickly update all events at
    // once. This call adds both the registry resource and the events resource into the world.
