...
use super::{QueryData, QueryItem, QueryState, WorldQueryFilter};
...
pub struct QueryParIter<'w, 's, Q: QueryData, F: WorldQueryFilter> {
...
impl<'w, 's, Q: QueryData, F: WorldQueryFilter> QueryParIter<'w, 's, Q, F> {
