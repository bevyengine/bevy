...
impl Observer {
    ...
    pub fn new_with_derived_name<E: Event, B: Bundle, M, I: IntoObserverSystem<E, B, M>>(
        ...
        NamedObserver {
            name: Name::new(format!("Observer {}", type_name_of_val(&system))),
            observer: Self::new(system),
        }
    }
...
/// An [`Observer`] and [`Name`]
#[derive(Bundle, Deref, DerefMut)]
pub struct NamedObserver {
    /// The name of the observer.
    ///
    /// If this was generated by [`Observer::new_with_derived_name`], this will contain
    /// the name of the system passed to the observer.
    pub name: Name,
    /// The new observer.
    #[deref]
    #[deref_mut]
