...
impl Entities {
    ...
    #[expect(clippy::unnecessary_fallible_conversions)] // Because `IdCursor::try_from` may fail on 32-bit platforms.
...
mod tests {
    ...
    #[test]
    #[expect(clippy::nonminimal_bool)] // This is intentionally testing `lt` and `ge` as separate functions.
