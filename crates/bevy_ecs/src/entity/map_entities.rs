...
/// of [`EntityMapper`]. This trait is automatically implemented for type that implements
/// `EntityMapper`.
...
///
/// These newly allocated references are guaranteed to never point to any living entity in that
/// world.
///
/// References are allocated by returning increasing generations starting from an internally
/// initialized base [`Entity`]. After it is finished being used by [`MapEntities`] implementations,
/// this entity is despawned and the requisite number of generations reserved.
