...
pub mod common_conditions {
    ...
    // /// assert_eq!(world.resource::<Counter>().0, 1);
    // /// ```
    // pub fn entering<S: States, M: 'static>(matcher: impl StateMatcher<S, M>) -> impl Condition<()> {
    //     IntoSystem::into_system(matcher)
    // }
    ...
    // /// assert_eq!(world.resource::<Counter>().0, 1);
    // /// ```
    // pub fn exiting<S: States, M: 'static>(matcher: impl StateMatcher<S, M>) -> impl Condition<()> {
    //     IntoSystem::into_system(matcher)
    // }
    ...
    // /// assert_eq!(world.resource::<Counter>().0, 1);
    // /// ```
    // pub fn transitioning<S: States, M1: 'static, M2: 'static>(
    //     from_matcher: impl StateMatcher<S, M1>,
    //     to_matcher: impl StateMatcher<S, M2>,
    // ) -> impl Condition<()> {
    //     to_matcher.and_then(from_matcher.invert_transition())
    // }
