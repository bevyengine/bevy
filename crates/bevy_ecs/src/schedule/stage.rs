use crate::{
    ...
    system::{BoxedExclusiveSystem, BoxedSystem, ExclusiveConfig, InsertionPoint, StageConfig},
    world::{World, WorldId},
};
use bevy_utils::{
    tracing::{info, warn},
...
mod tests {
    ...
    fn insertion_points() {
        ...
        world.get_resource_mut::<Vec<usize>>().unwrap().clear();
        let mut stage = SystemStage::parallel()
            .with_exclusive(make_parallel(2).before_commands())
            .with_exclusive(make_parallel(3).at_end())
            .with_system(make_parallel(1))
            .with_exclusive(make_parallel(0).at_start());
        stage.run(&mut world);
        assert_eq!(
            *world.get_resource::<Vec<usize>>().unwrap(),
            vec![0, 1, 2, 3]
    ...
    fn exclusive_before() {
        ...
        world.insert_resource(Vec::<usize>::new());
        let mut stage = SystemStage::parallel()
            .with_exclusive(make_exclusive(1).label("1").before("2"))
            .with_exclusive(make_exclusive(2).label("2"))
            .with_exclusive(make_exclusive(0).before("1"));
        stage.run(&mut world);
        stage.set_executor(Box::new(SingleThreadedExecutor::default()));
        stage.run(&mut world);
        assert_eq!(
    ...
    fn exclusive_mixed() {
        ...
        let mut stage = SystemStage::parallel()
            .with_exclusive(make_exclusive(2).label("2"))
            .with_exclusive(make_exclusive(1).after("0").before("2"))
            .with_exclusive(make_exclusive(0).label("0"))
            .with_exclusive(make_exclusive(4).label("4"))
            .with_exclusive(make_exclusive(3).after("2").before("4"));
        stage.run(&mut world);
        stage.set_executor(Box::new(SingleThreadedExecutor::default()));
        stage.run(&mut world);
        assert_eq!(
    ...
    fn exclusive_multiple_labels() {
        ...
        let mut stage = SystemStage::parallel()
            ...
            .with_exclusive(make_exclusive(2).after("first"))
        ...
        world.get_resource_mut::<Vec<usize>>().unwrap().clear();
        let mut stage = SystemStage::parallel()
            .with_exclusive(make_exclusive(2).after("01").label("2"))
            .with_exclusive(make_exclusive(1).label("01").after("0"))
            .with_exclusive(make_exclusive(0).label("01").label("0"))
            .with_exclusive(make_exclusive(4).label("4"))
            .with_exclusive(make_exclusive(3).after("2").before("4"));
        stage.run(&mut world);
        stage.set_executor(Box::new(SingleThreadedExecutor::default()));
        ...
        world.get_resource_mut::<Vec<usize>>().unwrap().clear();
        let mut stage = SystemStage::parallel()
            .with_exclusive(make_exclusive(2).label("234").label("2"))
            .with_system(make_exclusive(1).before("234").after("0"))
            .with_exclusive(make_exclusive(0).label("0"))
            .with_exclusive(make_exclusive(4).label("234").label("4"))
    ...
    fn exclusive_redundant_constraints() {
        ...
        let mut stage = SystemStage::parallel()
            ...
            .with_exclusive(make_exclusive(0).label("0").before("1"))
            .with_exclusive(make_exclusive(4).label("4").after("3"))
        ...
        let mut stage = SystemStage::parallel()
            ...
            .with_system_set(
                SystemSet::new()
                    ...
                    .with_exclusive(make_exclusive(1).label("1")),
            )
            .with_exclusive(make_exclusive(2).after("1"));
        stage.run(&mut world);
        stage.run(&mut world);
    ...
    fn exclusive_cycle_1() {
        ...
        world.insert_resource(Vec::<usize>::new());
        let mut stage =
            SystemStage::parallel().with_exclusive(make_exclusive(0).label("0").after("0"));
        stage.run(&mut world);
    }
    ...
    fn exclusive_cycle_2() {
        ...
        world.insert_resource(Vec::<usize>::new());
        let mut stage = SystemStage::parallel()
            .with_exclusive(make_exclusive(0).label("0").after("1"))
            .with_exclusive(make_exclusive(1).label("1").after("0"));
        stage.run(&mut world);
    }
    ...
    fn exclusive_cycle_3() {
        ...
        let mut stage = SystemStage::parallel()
            .with_exclusive(make_exclusive(0).label("0"))
            .with_exclusive(make_exclusive(1).after("0").before("2"))
            .with_exclusive(make_exclusive(2).label("2").before("0"));
        stage.run(&mut world);
    }
    ...
    fn ambiguity_detection() {
        ...
        let mut stage = SystemStage::parallel()
            .with_system(empty.label("0"))
            .with_system(empty.label("1").after("0"))
            .with_system(empty.label("2").after("1"))
            .with_system(empty.label("3").after("2"))
            .with_system(empty.label("4").after("3"))
            .with_system(empty.label("5").after("4"))
            .with_system(empty.label("6").after("5"))
            .with_system(empty.label("7").after("6"));
        stage.initialize_systems(&mut world);
        stage.rebuild_orders_and_dependencies();
        assert_eq!(find_ambiguities(&stage.exclusive_at_start).len(), 0);

        let mut stage = SystemStage::parallel()
            .with_system(empty.label("0").before("1").before("3"))
            .with_system(empty.label("1"))
            .with_system(empty.label("2").after("1"))
            .with_system(empty.label("3"))
            .with_system(empty.label("4").after("3").before("5"))
            .with_system(empty.label("5"))
            .with_system(empty.label("6").after("2").after("5"));
        stage.initialize_systems(&mut world);
        stage.rebuild_orders_and_dependencies();
        ...
        let mut stage = SystemStage::parallel()
            .with_system(empty.label("0").before("1").before("3"))
            .with_system(empty.label("1").in_ambiguity_set("a"))
            .with_system(empty.label("2").after("1"))
            .with_system(empty.label("3").in_ambiguity_set("a"))
            .with_system(empty.label("4").after("3").before("5"))
            .with_system(empty.label("5").in_ambiguity_set("a"))
            .with_system(empty.label("6").after("2").after("5"));
        stage.initialize_systems(&mut world);
        stage.rebuild_orders_and_dependencies();
        let ambiguities = find_ambiguities_first_labels(&stage.exclusive_at_start);
        ...
        let mut stage = SystemStage::parallel()
            .with_system(empty.label("0").in_ambiguity_set("a"))
            .with_system(empty.label("1").in_ambiguity_set("a"))
            .with_system(empty.label("2").in_ambiguity_set("a"))
            .with_system(empty.label("3").in_ambiguity_set("a"));
        stage.initialize_systems(&mut world);
        stage.rebuild_orders_and_dependencies();
        let ambiguities = find_ambiguities_first_labels(&stage.exclusive_at_start);
