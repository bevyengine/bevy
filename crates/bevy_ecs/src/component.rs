...
impl Components {
    ...
    pub fn init_component<T: Component>(&mut self, storages: &mut Storages) -> ComponentId {
        ...
        fn init_component(
            ...
            type_id: TypeId,
            get_component_descriptor: fn() -> ComponentDescriptor,
            register_required_components: fn(
                &mut Components,
                &mut Storages,
            ...
            if registered {
                ...
                register_required_components(this, storages, &mut required_components);
                let info = &mut this.components[id.index()];
                register_component_hooks(&mut info.hooks);
