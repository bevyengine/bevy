...
/// # Observers
///
/// "Buffered" Events, such as those sent directly in [`Events`] or sent using [`EventWriter`], do
/// _not_ automatically trigger any [`Observer`]s watching for that event, as each [`Event`] has
