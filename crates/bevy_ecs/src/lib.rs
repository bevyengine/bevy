...
mod tests {
    ...
    fn reserve_entities_across_worlds() {
        ...
        assert_eq!(
            e4,
            Entity::new(3, NonZeroU32::new(1).unwrap()),
        ...
        let high_non_existent_entity = Entity::new(6, NonZeroU32::new(1).unwrap());
        world_b
        ...
        let high_non_existent_but_reserved_entity = Entity::new(5, NonZeroU32::new(1).unwrap());
        assert!(
        ...
        assert_eq!(
            reserved_entities,
            vec![
                Entity::new(5, NonZeroU32::new(1).unwrap()),
                Entity::new(4, NonZeroU32::new(1).unwrap()),
                Entity::new(7, NonZeroU32::new(1).unwrap()),
                Entity::new(8, NonZeroU32::new(1).unwrap()),
            ],
