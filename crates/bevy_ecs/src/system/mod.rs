...
mod tests {
    ...
    fn query_system_gets() {
        ...
        assert!(*world.get_resource::<bool>(), "system ran");
    }
    ...
    fn changed_resource_system() {
        ...
        assert_eq!(world.get_resource::<Added>().0, 1);
        assert_eq!(world.get_resource::<Changed>().0, 1);

        schedule.run(&mut world);
        assert_eq!(world.get_resource::<Added>().0, 1);
        assert_eq!(world.get_resource::<Changed>().0, 1);

        *world.get_resource_mut::<bool>() = true;
        schedule.run(&mut world);
        assert_eq!(world.get_resource::<Added>().0, 1);
        assert_eq!(world.get_resource::<Changed>().0, 2);
    }
    ...
    fn local_system() {
        ...
        impl FromWorld for Foo {
            fn from_world(world: &mut World) -> Self {
                Foo {
                    value: *world.get_resource::<u32>() + 1,
                }
            }
        }
        ...
        assert!(*world.get_resource::<bool>());
    }
    ...
    fn removal_tracking() {
        ...
        assert_eq!(world.get_resource::<NSystems>().0, 2);
    }
