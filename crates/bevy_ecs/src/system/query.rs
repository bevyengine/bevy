...
/// # ) {}
/// # IntoSystem::into_system(tuple_system);
///
/// # fn non_tuple_system(
/// // This is the preferred method.
/// query: Query<&MyComponent>
/// # ) {}
/// # IntoSystem::into_system(non_tuple_system);
/// ```
///
...
///     }
/// }
/// # IntoSystem::into_system(immutable_query_system);
///
...
///     }
/// }
/// # IntoSystem::into_system(mutable_query_system);
/// ```
///
    ...
    F::Fetch: FilterFetch,
{
    ...
    ///     }
    /// }
    /// # IntoSystem::into_system(report_names_system);
    /// ```
    #[inline]
    ...
    ///     }
    /// }
    /// # IntoSystem::into_system(gravity_system);
    /// ```
    #[inline]
    ...
    ///     }
    /// }
    /// # IntoSystem::into_system(print_selected_character_name_system);
    /// ```
    #[inline]
    pub fn get(
        &'s self,
    ...
    ///     }
    /// }
    /// # IntoSystem::into_system(poison_system);
    /// ```
    #[inline]
    pub fn get_mut(
        &mut self,
    ...
    /// }
    /// # IntoSystem::into_system(player_system);
    /// ```
    ///
    /// # Panics
    ///
    ...
    ///     }
    /// }
    /// # IntoSystem::into_system(player_scoring_system);
    /// ```
    pub fn get_single(
        &'s self,
    ...
    ///     health.0 += 1;
    /// }
    /// # IntoSystem::into_system(regenerate_player_health_system);
    /// ```
    ///
    /// # Panics
    ///
