...
impl<'w, 's, Q: WorldQueryData, F: WorldQueryFilter> Query<'w, 's, Q, F> {
    ...
    ///    
    pub fn transmute_lens<NewQ: WorldQueryData>(&mut self) -> QueryLens<'_, NewQ> {
    ...
    pub fn transmute_lens_filtered<NewQ: WorldQueryData, NewF: WorldQueryFilter>(
        &mut self,
...
pub struct QueryLens<'w, Q: WorldQueryData, F: WorldQueryFilter = ()> {
    world: UnsafeWorldCell<'w>,
...
impl<'w, Q: WorldQueryData, F: WorldQueryFilter> QueryLens<'w, Q, F> {
...
impl<'w, 's, Q: WorldQueryData, F: WorldQueryFilter> From<&'s mut QueryLens<'w, Q, F>>
    for Query<'w, 's, Q, F>
{
...
impl<'w, 'q, Q: WorldQueryData, F: WorldQueryFilter> From<&'q mut Query<'w, '_, Q, F>>
    for QueryLens<'q, Q, F>
{
