...
unsafe impl<'a, T: Resource> SystemParam for Res<'a, T> {
    type State = (
        ComponentId,
        QueryState<Ref<'static, ResourceComponent<T>>, With<Internal>>,
    );
    ...
    fn init_state(world: &mut World) -> Self::State {
        (
            world
                ...
                .register_component::<ResourceComponent<T>>(),
            Query::<Ref<'static, ResourceComponent<T>>, With<Internal>>::init_state(world),
        )
    }
...
unsafe impl<'a, T: Resource> SystemParam for ResMut<'a, T> {
    type State = (
        ComponentId,
        QueryState<Mut<'static, ResourceComponent<T>>, With<Internal>>,
    );
    ...
    fn init_state(world: &mut World) -> Self::State {
        (
            world
                .components_registrator()
                .register_component::<ResourceComponent<T>>(),
            Query::<Mut<'static, ResourceComponent<T>>, With<Internal>>::init_state(world),
        )
    }
