...
use crate::{impl_bi_from_via, Alpha, Lcha, LinearRgba, Srgba, StandardColor, Xyza};
...
impl_bi_from_via! {
    impl From<LinearRgba> for Hwba via Srgba {}
    impl From<Lcha> for Hwba via Srgba {}
    impl From<Xyza> for Hwba via Srgba {}
}
