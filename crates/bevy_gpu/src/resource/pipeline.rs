use crate::{
    define_atomic_id, gpu_resource_wrapper, BindGroupLayout, BufferAddress, ColorTargetState,
    DepthStencilState, MultisampleState, PrimitiveState, Shader, ShaderDefVal, VertexAttribute,
