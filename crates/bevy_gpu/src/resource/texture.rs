...
/// Can be created via [`Device::create_texture`](crate::renderer::Device::create_texture).
#[derive(Clone, Debug)]
pub struct Texture {
    id: TextureId,
    value: ErasedTexture,
...
/// Can be created via [`Device::create_sampler`](crate::renderer::Device::create_sampler).
#[derive(Clone, Debug)]
pub struct Sampler {
    id: SamplerId,
    value: ErasedSampler,
