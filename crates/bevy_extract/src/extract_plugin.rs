...
mod test {
    ...
    fn extraction_works() {
        ...
        app.add_plugins(ExtractComponentPlugin::<ExtractApp, RenderComponent>::default());
        app.add_plugins(ExtractComponentPlugin::<ExtractApp, RenderComponentSeparate>::default());
