...
pub fn impl_full_reflect(
    ...
    let any_impls = if meta.is_remote_wrapper() {
        quote! {
            #[inline]
            fn into_any(self: #bevy_reflect_path::__macro_exports::Box<Self>) -> #bevy_reflect_path::__macro_exports::Box<dyn #FQAny> {
                #bevy_reflect_path::__macro_exports::Box::new(self.0)
            }
    ...
    quote! {
        impl #impl_generics #bevy_reflect_path::Reflect for #type_path #ty_generics #where_reflect_clause {
            ...
            #[inline]
            fn into_reflect(self: #bevy_reflect_path::__macro_exports::Box<Self>) -> #bevy_reflect_path::__macro_exports::Box<dyn #bevy_reflect_path::Reflect> {
                self
            }
            ...
            fn set(
                &mut self,
                value: #bevy_reflect_path::__macro_exports::Box<dyn #bevy_reflect_path::Reflect>
            ) -> #FQResult<(), #bevy_reflect_path::__macro_exports::Box<dyn #bevy_reflect_path::Reflect>> {
...
pub fn common_partial_reflect_methods(
    ...
    quote! {
        #[inline]
        fn try_into_reflect(
            self: #bevy_reflect_path::__macro_exports::Box<Self>
        ) -> #FQResult<#bevy_reflect_path::__macro_exports::Box<dyn #bevy_reflect_path::Reflect>, #bevy_reflect_path::__macro_exports::Box<dyn #bevy_reflect_path::PartialReflect>> {
            #FQResult::Ok(self)
        }
        ...
        #[inline]
        fn into_partial_reflect(self: #bevy_reflect_path::__macro_exports::Box<Self>) -> #bevy_reflect_path::__macro_exports::Box<dyn #bevy_reflect_path::PartialReflect> {
            self
        }
