...
impl<'a> Serialize for ReflectValueSerializer<'a> {
        ...
        S: serde::Serializer,
    {
        ...
        state.serialize_entry(type_fields::TYPE, self.value.type_path())?;
...
impl<'a> Serialize for StructSerializer<'a> {
        ...
        S: serde::Serializer,
    {
        ...
        state.serialize_entry(type_fields::TYPE, self.struct_value.type_path())?;
        state.serialize_entry(
            type_fields::STRUCT,
...
impl<'a> Serialize for TupleStructSerializer<'a> {
        ...
        S: serde::Serializer,
    {
        ...
        state.serialize_entry(type_fields::TYPE, self.tuple_struct.type_path())?;
        state.serialize_entry(
...
impl<'a> Serialize for EnumSerializer<'a> {
        ...
        S: serde::Serializer,
    {
        ...
        state.serialize_entry(type_fields::TYPE, self.enum_value.type_path())?;
        state.serialize_entry(
            type_fields::ENUM,
            &EnumValueSerializer {
...
impl<'a> Serialize for TupleSerializer<'a> {
        ...
        S: serde::Serializer,
    {
        ...
        state.serialize_entry(type_fields::TYPE, self.tuple.type_path())?;
        state.serialize_entry(
            type_fields::TUPLE,
...
impl<'a> Serialize for MapSerializer<'a> {
        ...
        S: serde::Serializer,
    {
        ...
        state.serialize_entry(type_fields::TYPE, self.map.type_path())?;
        state.serialize_entry(
            type_fields::MAP,
            &MapValueSerializer {
                map: self.map,
...
impl<'a> Serialize for ListSerializer<'a> {
    ...
    {
        let mut state = serializer.serialize_map(Some(2))?;
        state.serialize_entry(type_fields::TYPE, self.list.type_path())?;
        state.serialize_entry(
            type_fields::LIST,
            &ListValueSerializer {
                list: self.list,
...
impl<'a> Serialize for ArraySerializer<'a> {
    ...
    {
        let mut state = serializer.serialize_map(Some(2))?;
        state.serialize_entry(type_fields::TYPE, self.array.type_path())?;
        state.serialize_entry(
            type_fields::ARRAY,
