...
mod tests {
    ...
    fn type_name_should_be_prefixed_with_glam() {
        macro_rules! assert_name {
            ($t:ty) => {
                assert_eq!(<$t as TypeName>::name(), concat!("glam::", stringify!($t)))
            };
        }
