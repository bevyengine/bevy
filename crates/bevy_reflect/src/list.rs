...
use crate::{
    DynamicInfo, FromReflect, PartialReflect, ReflectMut, ReflectOwned, ReflectRef, TypeInfo, Typed,
};

/// A trait used to power [list-like] operations via [reflection].
///
/// This corresponds to types, like [`Vec`], which contain an ordered sequence
/// of elements that implement [`PartialReflect`].
///
...
///
/// ```
/// use bevy_reflect::{PartialReflect, List};
///
