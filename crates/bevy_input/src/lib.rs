...
impl Plugin for InputPlugin {
    fn build(&self, app: &mut AppBuilder) {
        app.add_event::<KeyboardInput>()
            ...
            .add_system_to_stage(bevy_app::CoreStage::Event, keyboard_input_system.system())
            ...
            .add_system_to_stage(bevy_app::CoreStage::Event, gamepad_event_system.system())
            .add_startup_system_to_stage(
                bevy_app::StartupStage::Startup,
