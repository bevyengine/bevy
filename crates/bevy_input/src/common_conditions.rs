...
///         .add_systems_to(Update, pause_menu.run_if(input_toggle_active(false, KeyCode::Escape)))
///         .run();
/// }
///
/// fn pause_menu() {
...
///         .add_systems_to(Update, pause_menu.run_if(|paused: Res<Paused>| paused.0))
///         .run();
/// }
///
...
///     App::new()
///         .add_plugins(DefaultPlugins)
///         .add_systems_to(Update, jump.run_if(input_just_pressed(KeyCode::Space)))
///         .run();
/// }
///
/// # fn jump() {}
