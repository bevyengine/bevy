...
pub struct Input<T: Eq + Hash> {
    ...
    /// A collection of every button that have just been released.
...
mod test {
    ...
    fn test_get_pressed() {
        ...
        for pressed in input.get_pressed() {
            assert!(input.pressed.contains(pressed));
        }
    }
    ...
    fn test_get_just_pressed() {
        ...
        for just_pressed in input.get_just_pressed() {
            assert!(input.just_pressed.contains(just_pressed));
        }
    }
    ...
    fn test_get_just_released() {
        ...
        for just_released in input.get_just_released() {
            assert!(input.just_released.contains(just_released));
        }
    }
