...
use super::widgets::{WidgetsPlugin, ScrollViewBuilder, ScrollContent};
...
pub fn create_entity_panel(parent: &mut ChildSpawnerCommands) {
    parent
        .spawn((
            Node {
                width: Val::Px(380.0),
...
pub fn create_component_panel(parent: &mut ChildSpawnerCommands) {
    parent
        .spawn((
            Node {
                width: Val::Percent(100.0),
