...
pub(crate) const ACCENT_POSITIONS: [[i8; 2]; 24] = [
    [5, 25],
    [8, 22], // grave
    [5, 22],
    [8, 25], // acute
    ...
    [13, 25], // tilde
    [4, 24],
    [5, 25], // umlaut left dot
    [11, 24],
    [12, 25], // umlaut right dot
    [6, 26],
    [9, 29],
    [12, 26],
    [9, 23],
...
pub(crate) const ACCENT_STROKES: [Range<usize>; 8] =
    [0..2, 2..4, 4..7, 7..11, 11..13, 13..15, 15..20, 20..24];

pub(crate) const SIMPLEX_EXTENDED: [(char, i8, Range<usize>, Range<usize>); 53] = [
    ('À', 18, 53..56, 0..1),
    ('Á', 18, 53..56, 1..2),
    ('Â', 18, 53..56, 2..3),
    ('Ã', 18, 53..56, 3..4),
...
pub const SIMPLEX_STROKE_FONT: StrokeFont = StrokeFont {
    ...
    extended_positions: &ACCENT_POSITIONS,
    extended_strokes: &ACCENT_STROKES,
    extended: &SIMPLEX_EXTENDED,
};
