...
///
/// Requires to be loaded after [`PbrPlugin`](bevy_pbr::PbrPlugin) or [`Mesh2dRenderPlugin`](bevy_render_2d::Mesh2dRenderPlugin).
#[derive(Default)]
...
impl Plugin for GizmoPlugin {
    fn build(&self, app: &mut App) {
        ...
        if let Some(render_app) = app.get_sub_app_mut(RenderApp) {
            ...
            #[cfg(feature = "bevy_render_2d")]
            if app.is_plugin_added::<bevy_render_2d::Mesh2dRenderPlugin>() {
                app.add_plugins(pipeline_2d::LineGizmo2dPlugin);
            } else {
                tracing::warn!("bevy_render_2d feature is enabled but bevy_render_2d::Mesh2dRenderPlugin was not detected. Are you sure you loaded GizmoPlugin after Mesh2dRenderPlugin?");
            }
            #[cfg(feature = "bevy_pbr")]
