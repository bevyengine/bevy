...
use bevy_math::{
    bounding::{Aabb3d, Bounded2d, Bounded3d, BoundingCircle, BoundingSphere, BoundingVolume},
    ops, Isometry2d, Isometry3d, Mat3, Vec2, Vec3, Vec3A,
};
...
mod tests {
    use bevy_math::{
        ...
        ops, Dir3, Isometry3d, Quat, Vec3, Vec3A,
    };
