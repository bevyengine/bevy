//! Implement [`BoundedExtrusion`] for all the primitives in `bevy_shapes`
...
use bevy_math::{
    ...
    ops, Isometry2d, Isometry3d, Quat, Rot2, Vec2, Vec3A, Vec3Swizzles,
};
...
mod tests {
    ...
    use bevy_math::{
        ...
        ops, Dir2, EulerRot, Isometry3d, Quat, Vec2, Vec3, Vec3A,
    };
