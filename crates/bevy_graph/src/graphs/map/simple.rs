...
use crate::{
    ...
    iters,
    utils::{iter_choice::IterChoice, wrapped_indices_iterator::WrappedIndicesIterator},
};
...
impl<N, E, const DIRECTED: bool> Graph<N, E> for SimpleMapGraph<N, E, DIRECTED> {
    ...
    type EdgesOf<'e> = iters::EdgesByIdx<'e, E, &'e EdgeIdx, IterChoice<&'e EdgeIdx, std::iter::Chain<hashbrown::hash_map::Values<'e, NodeIdx, EdgeIdx>, hashbrown::hash_map::Values<'e, NodeIdx, EdgeIdx>>, hashbrown::hash_map::Values<'e, NodeIdx, EdgeIdx>>> where Self: 'e;
    ...
    type EdgesOfMut<'e> = iters::EdgesByIdxMut<'e, E, &'e EdgeIdx, IterChoice<&'e EdgeIdx, std::iter::Chain<hashbrown::hash_map::Values<'e, NodeIdx, EdgeIdx>, hashbrown::hash_map::Values<'e, NodeIdx, EdgeIdx>>, hashbrown::hash_map::Values<'e, NodeIdx, EdgeIdx>>> where Self: 'e;
    ...
    type Neighbors<'n> = iters::NodesByIdx<'n, N, &'n NodeIdx, IterChoice<&'n NodeIdx, std::iter::Chain<hashbrown::hash_map::Keys<'n, NodeIdx, EdgeIdx>, hashbrown::hash_map::Keys<'n, NodeIdx, EdgeIdx>>, hashbrown::hash_map::Keys<'n, NodeIdx, EdgeIdx>>> where Self: 'n;
    ...
    type NeighborsMut<'n> = iters::NodesByIdxMut<'n, N, &'n NodeIdx, IterChoice<&'n NodeIdx, std::iter::Chain<hashbrown::hash_map::Keys<'n, NodeIdx, EdgeIdx>, hashbrown::hash_map::Keys<'n, NodeIdx, EdgeIdx>>, hashbrown::hash_map::Keys<'n, NodeIdx, EdgeIdx>>> where Self: 'n;
    ...
    type Isolated<'n> = iters::Isolated<&'n N, iters::ZipDegree<'n, SimpleMapStorage, &'n N, slotmap::hop::Iter<'n, NodeIdx, N>, DIRECTED>> where Self: 'n;
    fn isolated(&self) -> Self::Isolated<'_> {
        iters::Isolated::new(iters::ZipDegree::new(self.nodes.iter(), &self.adjacencies))
    }

    type IsolatedMut<'n> = iters::Isolated<&'n mut N, iters::ZipDegree<'n, SimpleMapStorage, &'n mut N, slotmap::hop::IterMut<'n, NodeIdx, N>, DIRECTED>> where Self: 'n;
    ...
    type IncomingEdgesOf<'e> = iters::EdgesByIdx<'e, E, &'e EdgeIdx, hashbrown::hash_map::Values<'e, NodeIdx, EdgeIdx>> where Self: 'e;
    ...
    type IncomingEdgesOfMut<'e> = iters::EdgesByIdxMut<'e, E, &'e EdgeIdx, hashbrown::hash_map::Values<'e, NodeIdx, EdgeIdx>> where Self: 'e;
    ...
    type OutgoingEdgesOf<'e> = iters::EdgesByIdx<'e, E, &'e EdgeIdx, hashbrown::hash_map::Values<'e, NodeIdx, EdgeIdx>> where Self: 'e;
    ...
    type OutgoingEdgesOfMut<'e> = iters::EdgesByIdxMut<'e, E, &'e EdgeIdx, hashbrown::hash_map::Values<'e, NodeIdx, EdgeIdx>> where Self: 'e;
    ...
    type InNeighbors<'n> = iters::NodesByIdx<'n, N, &'n NodeIdx, hashbrown::hash_map::Keys<'n, NodeIdx, EdgeIdx>> where Self: 'n;
    ...
    type OutNeighbors<'n> = iters::NodesByIdx<'n, N, &'n NodeIdx, hashbrown::hash_map::Keys<'n, NodeIdx, EdgeIdx>> where Self: 'n;
    ...
    type Sources<'n> = iters::Isolated<&'n N, iters::ZipInDegree<'n, SimpleMapStorage, &'n N, slotmap::hop::Iter<'n, NodeIdx, N>>> where Self: 'n;
    ...
    type SourcesMut<'n> = iters::Isolated<&'n mut N, iters::ZipInDegree<'n, SimpleMapStorage, &'n mut N, slotmap::hop::IterMut<'n, NodeIdx, N>>> where Self: 'n;
    ...
    type Sinks<'n> = iters::Isolated<&'n N, iters::ZipOutDegree<'n, SimpleMapStorage, &'n N, slotmap::hop::Iter<'n, NodeIdx, N>>> where Self: 'n;
    ...
    type SinksMut<'n> = iters::Isolated<&'n mut N, iters::ZipOutDegree<'n, SimpleMapStorage, &'n mut N, slotmap::hop::IterMut<'n, NodeIdx, N>>> where Self: 'n;
