...
impl<N, E, const DIRECTED: bool> Graph<N, E> for SimpleMapGraph<N, E, DIRECTED> {
    ...
    type InNeighbors<'n> = iters::NodesByIdx<'n, N, hashbrown::hash_map::Keys<'n, NodeIdx, EdgeIdx>> where Self: 'n;
    ...
    type OutNeighbors<'n> = iters::NodesByIdx<'n, N, hashbrown::hash_map::Keys<'n, NodeIdx, EdgeIdx>> where Self: 'n;
