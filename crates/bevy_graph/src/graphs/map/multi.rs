...
impl<N, E, const DIRECTED: bool> Graph<N, E> for MultiMapGraph<N, E, DIRECTED> {
    ...
    type Sources<'n> = iters::Sources<&'n N, iters::ZipInDegree<'n, MultiMapStorage, &'n N, slotmap::hop::Iter<'n, NodeIdx, N>>> where Self: 'n;
    ...
    type SourcesMut<'n> = iters::Sources<&'n mut N, iters::ZipInDegree<'n, MultiMapStorage, &'n mut N, slotmap::hop::IterMut<'n, NodeIdx, N>>> where Self: 'n;
