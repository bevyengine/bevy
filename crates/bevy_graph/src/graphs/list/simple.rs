...
impl<N, E, const DIRECTED: bool> Graph<N, E> for SimpleListGraph<N, E, DIRECTED> {
    ...
    type Sources<'n> = iters::NodesByIdx<'n, N, iters::Sources<iters::ZipInDegree<'n, SimpleListStorage, slotmap::hop::Keys<'n, NodeIdx, N>>>> where Self: 'n;
    ...
    /*type SourcesMut<'n> = iters::NodesByIdxMut<'n, N, iters::Sources<iters::ZipInDegree<'n, SimpleListStorage, slotmap::hop::Keys<'n, NodeIdx, N>>>> where Self: 'n;
