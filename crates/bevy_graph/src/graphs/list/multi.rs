...
use crate::{
    ...
    iters,
    utils::{
        iter_choice::IterChoice, vecmap::VecMap, vecset::VecSet,
        wrapped_indices_iterator::WrappedIndicesIterator,
    },
};
...
impl<N, E, const DIRECTED: bool> Graph<N, E> for MultiListGraph<N, E, DIRECTED> {
    ...
    type Isolated<'n> = iters::Isolated<&'n N, iters::ZipDegree<'n, MultiListStorage, &'n N, slotmap::hop::Iter<'n, NodeIdx, N>, DIRECTED>> where Self: 'n;
    fn isolated(&self) -> Self::Isolated<'_> {
        iters::Isolated::new(iters::ZipDegree::new(self.nodes.iter(), &self.adjacencies))
    }

    type IsolatedMut<'n> = iters::Isolated<&'n mut N, iters::ZipDegree<'n, MultiListStorage, &'n mut N, slotmap::hop::IterMut<'n, NodeIdx, N>, DIRECTED>> where Self: 'n;
    ...
    type IncomingEdgesOfMut<'e> = iters::EdgesByIdxMut<'e, E, &'e EdgeIdx, std::iter::Flatten<crate::utils::vecmap::Values<'e, NodeIdx, Vec<EdgeIdx>>>> where Self: 'e;
    ...
    type OutgoingEdgesOf<'e> = iters::EdgesByIdx<'e, E, &'e EdgeIdx, std::iter::Flatten<crate::utils::vecmap::Values<'e, NodeIdx, Vec<EdgeIdx>>>> where Self: 'e;
    ...
    type OutgoingEdgesOfMut<'e> = iters::EdgesByIdxMut<'e, E, &'e EdgeIdx, std::iter::Flatten<crate::utils::vecmap::Values<'e, NodeIdx, Vec<EdgeIdx>>>> where Self: 'e;
    ...
    type InNeighbors<'n> = iters::NodesByIdx<'n, N, &'n NodeIdx, crate::utils::vecmap::Keys<'n, NodeIdx, Vec<EdgeIdx>>> where Self: 'n;
    ...
    type InNeighborsMut<'n> = iters::NodesByIdxMut<'n, N, &'n NodeIdx, crate::utils::vecmap::Keys<'n, NodeIdx, Vec<EdgeIdx>>> where Self: 'n;
    ...
    type OutNeighbors<'n> = iters::NodesByIdx<'n, N, &'n NodeIdx, crate::utils::vecmap::Keys<'n, NodeIdx, Vec<EdgeIdx>>> where Self: 'n;
    ...
    type OutNeighborsMut<'n> = iters::NodesByIdxMut<'n, N, &'n NodeIdx, crate::utils::vecmap::Keys<'n, NodeIdx, Vec<EdgeIdx>>> where Self: 'n;
    ...
    type Sources<'n> = iters::Isolated<&'n N, iters::ZipInDegree<'n, MultiListStorage, &'n N, slotmap::hop::Iter<'n, NodeIdx, N>>> where Self: 'n;
    ...
    type SourcesMut<'n> = iters::Isolated<&'n mut N, iters::ZipInDegree<'n, MultiListStorage, &'n mut N, slotmap::hop::IterMut<'n, NodeIdx, N>>> where Self: 'n;
    ...
    type Sinks<'n> = iters::Isolated<&'n N, iters::ZipOutDegree<'n, MultiListStorage, &'n N, slotmap::hop::Iter<'n, NodeIdx, N>>> where Self: 'n;
    ...
    type SinksMut<'n> = iters::Isolated<&'n mut N, iters::ZipOutDegree<'n, MultiListStorage, &'n mut N, slotmap::hop::IterMut<'n, NodeIdx, N>>> where Self: 'n;
