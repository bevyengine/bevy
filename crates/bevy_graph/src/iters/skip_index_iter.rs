...
pub struct SkipIndexIter<'g, V: 'g, I: Iterator<Item = (&'g NodeIdx, V)>> {
    index_to_skip: NodeIdx,
    inner: I,
}

impl<'g, V: 'g, I: Iterator<Item = (&'g NodeIdx, V)>> SkipIndexIter<'g, V, I> {
...
impl<'g, V: 'g, I: Iterator<Item = (&'g NodeIdx, V)>> Iterator for SkipIndexIter<'g, V, I> {
