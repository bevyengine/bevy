...
pub struct NodesByIdxMut<'g, N: 'g, I: Iterator<Item = NodeIdx>> {
    nodes: &'g mut HopSlotMap<NodeIdx, N>,
    inner: I,
}

impl<'g, N: 'g, I: Iterator<Item = NodeIdx>> NodesByIdxMut<'g, N, I> {
...
impl<'g, N: 'g, I: Iterator<Item = NodeIdx>> Iterator for NodesByIdxMut<'g, N, I> {
    type Item = &'g mut N;
