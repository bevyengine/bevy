...
use bevy_ecs::{prelude::StageConfig, system::{Res, ResMut}};
...
impl Plugin for LogDiagnosticsPlugin {
    fn build(&self, app: &mut App) {
        ...
        if self.debug {
            app.add_system(Self::log_diagnostics_debug_system.stage(CoreStage::PostUpdate));
        } else {
            app.add_system(Self::log_diagnostics_system.stage(CoreStage::PostUpdate));
        }
    }
}
