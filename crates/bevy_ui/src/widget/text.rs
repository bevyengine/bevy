...
fn create_text_measure<'a>(
    ...
    mut content_size: MutInherited<ContentSize>,
    mut text_flags: MutInherited<TextNodeFlags>,
    mut computed: MutInherited<ComputedTextBlock>,
...
fn queue_text(
    ...
    mut text_flags: MutInherited<TextNodeFlags>,
    text_layout_info: MutInherited<TextLayoutInfo>,
