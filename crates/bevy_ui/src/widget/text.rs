...
fn create_text_measure<'a>(
    ...
    mut content_size: MutComponent<ContentSize>,
    mut text_flags: MutComponent<TextNodeFlags>,
    mut computed: MutComponent<ComputedTextBlock>,
...
fn queue_text(
    ...
    mut text_flags: MutComponent<TextNodeFlags>,
    text_layout_info: MutComponent<TextLayoutInfo>,
