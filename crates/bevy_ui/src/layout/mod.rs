...
pub fn ui_layout_system(
    ...
    mut node_transform_query: Query<(Entity, &mut NodeSize, &mut Transform, Option<&Parent>)>,
    ...
    for (entity, mut node_size, mut transform, parent) in &mut node_transform_query {
