...
pub mod prelude {
    ...
    #[doc(hidden)]
    pub use crate::state::{
        last_transition, EnterSchedules, ExitSchedules, NextState, OnEnter, OnExit, OnTransition,
        State, StateSet, StateTransition, StateTransitionEvent, States, SubStates,
        TransitionSchedules,
    };
    #[doc(hidden)]
