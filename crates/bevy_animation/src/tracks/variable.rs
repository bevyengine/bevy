...
// impl<T> TrackVariableInterpolated<T> {
...
//     #[test]
//     fn curve_evaluation() {
//         let curve = TrackVariableInterpolated::new(
...
//     #[should_panic]
//     fn curve_bad_length() {
//         let _ = TrackVariableInterpolated::new(vec![0.0, 0.5, 1.0], vec![0.0, 1.0]);
//     }

//     #[test]
//     #[should_panic]
//     fn curve_time_samples_not_sorted() {
//         let _ = TrackVariableInterpolated::new(vec![0.0, 1.5, 1.0], vec![0.0, 1.0, 2.0]);
//     }
// }
