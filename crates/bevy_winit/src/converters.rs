...
use winit::{keyboard::Key, platform::scancode::KeyCodeExtScancode};

pub fn convert_keyboard_input(keyboard_input: &winit::event::KeyEvent) -> KeyboardInput {
    KeyboardInput {
        scan_code: keyboard_input.physical_key.to_scancode(),
        state: convert_element_state(keyboard_input.state),
        key_code: convert_virtual_key_code(keyboard_input.physical_key),
    }
}
...
pub fn convert_virtual_key_code(virtual_key_code: winit::keyboard::KeyCode) -> KeyCode {
