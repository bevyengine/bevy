...
fn move_enemies_to_player(
    mut enemies: Query<&mut Transform3d, With<Enemy>>,
    player: Query<&Transform3d, With<Player>>,
) {
    // ...
}
...
This will panic, as it's not possible to have both a mutable and an immutable query on `Transform3d` at the same time.
...
fn move_enemies_to_player(
    mut enemies: Query<&mut Transform3d, With<Enemy>>,
    player: Query<&Transform3d, (With<Player>, Without<Enemy>)>,
) {
    // ...
}
...
fn move_enemies_to_player(
    mut transforms: ParamSet<(
        Query<&mut Transform3d, With<Enemy>>,
        Query<&Transform3d, With<Player>>,
    )>,
) {
    // ...
}
