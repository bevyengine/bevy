...
Solution #2: use a [`ParamSet`](https://docs.rs/bevy/*/bevy/prelude/struct.ParamSet.html)

A [`ParamSet`](https://docs.rs/bevy/*/bevy/prelude/struct.ParamSet.html) will let you have conflicting queries as a parameter, but you will still be responsible for not using them at the same time in your system.
