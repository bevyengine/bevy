...
fn use_0_and_despawn_1(mut commands: Commands, my_entities: Res<MyEntities>) -> Result {
    commands.entity(my_entities.0)?.insert(Hello);
    commands.entity(my_entities.1)?.despawn();
    Ok(())
}

fn use_1_and_despawn_0(mut commands: Commands, my_entities: Res<MyEntities>) -> Result {
