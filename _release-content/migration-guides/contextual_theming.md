...
you have used in your custom theme. Then, create a map from these `ThemeToken`s to your
`SemanticToken`s, and map these`SemanticToken`s to your desired colors.
