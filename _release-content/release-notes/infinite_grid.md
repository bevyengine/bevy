...
Simply drawing lines doesn't work well because the mesh has to end somewhere. The lines that reach toward the horizon create aliasing artifacts and [Moiré patterns] no matter how far you extend it.
...
Check out the new [`infinite_grid` example] to see it in action!

![infinite grid](grid.jpg)
...
[`infinite_grid` example]: https://bevy.org/examples/dev-tools/infinite_grid/
[`InfiniteGridSettings`]: https://docs.rs/bevy/0.19.0/bevy/dev_tools/infinite_grid/struct.InfiniteGridSettings.html
[`InfiniteGridPlugin`]: https://docs.rs/bevy/0.19.0/bevy/dev_tools/infinite_grid/struct.InfiniteGridPlugin.html
[`InfiniteGrid`]: https://docs.rs/bevy/0.19.0/bevy/dev_tools/infinite_grid/struct.InfiniteGrid.html
