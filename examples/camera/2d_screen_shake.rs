...
fn setup_scene(
    ...
    commands.spawn((
        ...
        MeshMaterial2d(materials.add(Color::srgb(0.25, 0.94, 0.91))), /* RGB values must be in
                                                                       * range 0.0 to 1.0 */
    ...
    commands.spawn((
        ...
        MeshMaterial2d(materials.add(Color::srgb(0.85, 0.0, 0.2))), /* RGB values must be in
                                                                     * range 0.0 to 1.0 */
    ...
    commands.spawn((
        ...
        MeshMaterial2d(materials.add(Color::srgb(0.5, 0.8, 0.2))), /* RGB values must be in
                                                                    * range 0.0 to 1.0 */
