//! Sometimes, you want an extremely flexible way to store logic associated with an entity, but you do not know the type of the callback function.
//! This example demonstrates how to store arbitrary boxed systems in components and run them on demand.
//!
