...
fn main(){
	App::new()
		...
		.add_archetype_invariant(ArchetypeInvariant::<(GlobalTransform,), (Transform,)>::requires_one())
		...
		.add_archetype_invariant(ArchetypeInvariant::<(Transform,), (GlobalTransform,)>::requires_one())
        ...
        .add_archetype_invariant(ArchetypeInvariant {
			...
			// TODO: replace this with ArchetypeStatement::True (once it's added)
            premise: ArchetypeStatement::<()>::all_of(),
