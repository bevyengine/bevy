...
fn change_color(
    ...
    for handle in query.iter() {
        ...
        material.color.b = (time.seconds_since_startup() * 5.0).sin() as f32 + 2.0;
    }
}
...
impl FromWorld for ButtonMaterials {
    fn from_world(world: &mut World) -> Self {
        ...
        ButtonMaterials {
            normal: materials.add(rgba!(0.15, 0.15, 0.15).into()),
            hovered: materials.add(rgba!(0.25, 0.25, 0.25).into()),
            pressed: materials.add(rgba!(0.35, 0.75, 0.35).into()),
        }
    }
}
