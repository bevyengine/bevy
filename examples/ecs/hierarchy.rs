...
//!
//! See also the `multiple_sprites_one_parent_entity` example, which uses a similar technique to stitch
//! together multiple sprites into a single, large parent sprite.
