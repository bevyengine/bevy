...
impl ComputedStates for InGame {
    ...
    // The compute function takes in the `SourceStates` wrapped in `Option`'s, in this case the complex type
                ...
                .spawn((
                    ButtonBundle {
                        ...
                        background_color: match tutorial_state.get() {
                            TutorialState::Active => ACTIVE_BUTTON.into(),
                            TutorialState::Inactive => NORMAL_BUTTON.into(),
                        },
                        ..default()
                    },
                    MenuButton::Tutorial,
