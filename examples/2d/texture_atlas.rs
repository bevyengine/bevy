...
fn main() {
    App::new()
        ...
        .add_state::<AppState>()
        .add_systems_to(OnEnter(AppState::Setup), load_textures)
        .add_systems_to(Update, check_textures.in_set(OnUpdate(AppState::Setup)))
        .add_systems_to(OnEnter(AppState::Finished), setup)
        .run();
}
