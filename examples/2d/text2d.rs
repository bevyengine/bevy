...
fn setup(mut commands: Commands, asset_server: Res<AssetServer>) {
    ...
    commands.spawn((
        ...
        text_font.clone(),
        TextLayoutSettings::new_with_justify(text_justification),
        AnimateTranslation,
    ));
    ...
    commands.spawn((
        ...
        children![(
            ...
            TextLayoutSettings::new(JustifyText::Left, LineBreak::WordBoundary),
    ...
    commands.spawn((
        ...
        children![(
            ...
            slightly_smaller_text_font.clone(),
            TextLayoutSettings::new(JustifyText::Left, LineBreak::AnyCharacter),
            // Wrap text in the rectangle
