//! Shows a tilemap rendered with a single draw call.

use bevy::{
    prelude::*,
    remote::{http::RemoteHttpPlugin, RemotePlugin},
    sprite::{TileData, TileStorage, Tilemap, TilemapChunk, Tileset},
};
use rand::{Rng, SeedableRng};
use rand_chacha::ChaCha8Rng;

const TILESET_SIZE: u16 = 4;
...
fn update_tilemap(time: Res<Time>, mut query: Query<(&mut TileStorage, &mut UpdateTimer)>) {
