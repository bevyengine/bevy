...
fn setup_sprites(mut commands: Commands, asset_server: Res<AssetServer>) {
    ...
    let rects = [
        Rect {
            ...
            transform: Transform::from_translation(Vec3::new(-570.0, 230., 0.)),
        ...
        Rect {
            ...
            transform: Transform::from_translation(Vec3::new(-450.0, 230., 0.)),
            texture: square.clone(),
        ...
        Rect {
            ...
            transform: Transform::from_translation(Vec3::new(-330.0, 230.0, 0.0)),
            texture: square.clone(),
        ...
        Rect {
            ...
            transform: Transform::from_translation(Vec3::new(-210.0, 230.0, 0.0)),
            texture: square.clone(),
        ...
        Rect {
            ...
            transform: Transform::from_translation(Vec3::new(10.0, 290.0, 0.0)),
            texture: square.clone(),
            image_mode: SpriteImageMode::Scale(ScalingMode::FillStart),
        },
        Rect {
            ...
            transform: Transform::from_translation(Vec3::new(10.0, 155.0, 0.0)),
            texture: square.clone(),
            image_mode: SpriteImageMode::Scale(ScalingMode::FillEnd),
        },
        Rect {
            ...
            text: "Fill Center".to_string(),
            transform: Transform::from_translation(Vec3::new(280.0, 230.0, 0.0)),
        ...
        Rect {
            ...
            text: "Fill Center".to_string(),
            transform: Transform::from_translation(Vec3::new(500.0, 230.0, 0.0)),
            texture: square.clone(),
            image_mode: SpriteImageMode::Scale(ScalingMode::FillCenter),
        },
        Rect {
            ...
            text: "Stretched".to_string(),
            transform: Transform::from_translation(Vec3::new(-570.0, -40., 0.0)),
            texture: banner.clone(),
            image_mode: SpriteImageMode::Auto,
        },
        Rect {
            ...
            transform: Transform::from_translation(Vec3::new(-400.0, -40., 0.0)),
            texture: banner.clone(),
        ...
        Rect {
            ...
            transform: Transform::from_translation(Vec3::new(-180.0, -40.0, 0.0)),
            texture: banner.clone(),
