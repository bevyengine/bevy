...
fn setup_sprites(mut commands: Commands, asset_server: Res<AssetServer>) {
    ...
    let rects = [
        Rect {
            ...
            transform: Transform3d::from_translation(Vec3::new(-570., 230., 0.)),
        ...
        Rect {
            ...
            transform: Transform3d::from_translation(Vec3::new(-450., 230., 0.)),
            texture: square.clone(),
        ...
        Rect {
            ...
            transform: Transform3d::from_translation(Vec3::new(-330., 230., 0.)),
            texture: square.clone(),
        ...
        Rect {
            ...
            transform: Transform3d::from_translation(Vec3::new(-210., 230., 0.)),
            texture: square.clone(),
        ...
        Rect {
            ...
            transform: Transform3d::from_translation(Vec3::new(10., 290., 0.)),
            texture: square.clone(),
            image_mode: SpriteImageMode::Scale(ScalingMode::FillStart),
        },
        Rect {
            ...
            transform: Transform3d::from_translation(Vec3::new(10., 155., 0.)),
            texture: square.clone(),
            image_mode: SpriteImageMode::Scale(ScalingMode::FillEnd),
        },
        Rect {
            ...
            text: "Fill Center".to_string(),
            transform: Transform3d::from_translation(Vec3::new(280., 230., 0.)),
        ...
        Rect {
            ...
            text: "Fill Center".to_string(),
            transform: Transform3d::from_translation(Vec3::new(500., 230., 0.)),
            texture: square.clone(),
            image_mode: SpriteImageMode::Scale(ScalingMode::FillCenter),
        },
        Rect {
            ...
            text: "Stretched".to_string(),
            transform: Transform3d::from_translation(Vec3::new(-570., -40., 0.)),
            texture: banner.clone(),
            image_mode: SpriteImageMode::Auto,
        },
        Rect {
            ...
            transform: Transform3d::from_translation(Vec3::new(-400., -40., 0.)),
            texture: banner.clone(),
        ...
        Rect {
            ...
            transform: Transform3d::from_translation(Vec3::new(-180., -40., 0.)),
            texture: banner.clone(),
        ...
        Rect {
            ...
            transform: Transform3d::from_translation(Vec3::new(40., -40., 0.)),
            texture: banner.clone(),
        ...
        Rect {
            ...
            text: "Fit Center".to_string(),
            transform: Transform3d::from_translation(Vec3::new(210., -40., 0.)),
            texture: banner.clone(),
            image_mode: SpriteImageMode::Scale(ScalingMode::FitCenter),
        },
    ];
    ...
    for rect in rects {
        ...
        cmd.with_children(|builder| {
            builder.spawn((
                ...
                Transform3d::from_xyz(0., -0.5 * rect.size.y - 10., 0.),
...
fn setup_texture_atlas(
    ...
    let sprite_sheets = [
        SpriteSheet {
            ...
            text: "Stretched".to_string(),
            transform: Transform3d::from_translation(Vec3::new(-570., -200., 0.)),
            texture: gabe.clone(),
            image_mode: SpriteImageMode::Auto,
        ...
        SpriteSheet {
            size: Vec2::new(120., 50.),
            text: "Fill Center".to_string(),
            transform: Transform3d::from_translation(Vec3::new(-570., -300., 0.)),
            texture: gabe.clone(),
            image_mode: SpriteImageMode::Scale(ScalingMode::FillCenter),
            atlas: gabe_atlas.clone(),
            indices: animation_indices_gabe.clone(),
        ...
        SpriteSheet {
            size: Vec2::new(120., 50.),
            text: "Fill Start".to_string(),
            transform: Transform3d::from_translation(Vec3::new(-430., -200., 0.)),
            texture: gabe.clone(),
            image_mode: SpriteImageMode::Scale(ScalingMode::FillStart),
            atlas: gabe_atlas.clone(),
            indices: animation_indices_gabe.clone(),
        ...
        SpriteSheet {
            size: Vec2::new(120., 50.),
            text: "Fill End".to_string(),
            transform: Transform3d::from_translation(Vec3::new(-430., -300., 0.)),
            texture: gabe.clone(),
            image_mode: SpriteImageMode::Scale(ScalingMode::FillEnd),
            atlas: gabe_atlas.clone(),
            indices: animation_indices_gabe.clone(),
        ...
        SpriteSheet {
            ...
            text: "Fill Center".to_string(),
            transform: Transform3d::from_translation(Vec3::new(-300., -250., 0.)),
            texture: gabe.clone(),
            image_mode: SpriteImageMode::Scale(ScalingMode::FillCenter),
            atlas: gabe_atlas.clone(),
            indices: animation_indices_gabe.clone(),
        ...
        SpriteSheet {
            size: Vec2::new(50., 120.),
            text: "Fill Start".to_string(),
            transform: Transform3d::from_translation(Vec3::new(-190., -250., 0.)),
            texture: gabe.clone(),
            image_mode: SpriteImageMode::Scale(ScalingMode::FillStart),
            atlas: gabe_atlas.clone(),
            indices: animation_indices_gabe.clone(),
        ...
        SpriteSheet {
            size: Vec2::new(50., 120.),
            text: "Fill End".to_string(),
            transform: Transform3d::from_translation(Vec3::new(-90., -250., 0.)),
            texture: gabe.clone(),
            image_mode: SpriteImageMode::Scale(ScalingMode::FillEnd),
            atlas: gabe_atlas.clone(),
            indices: animation_indices_gabe.clone(),
        ...
        SpriteSheet {
            size: Vec2::new(120., 50.),
            text: "Fit Center".to_string(),
            transform: Transform3d::from_translation(Vec3::new(20., -200., 0.)),
            texture: gabe.clone(),
            image_mode: SpriteImageMode::Scale(ScalingMode::FitCenter),
            atlas: gabe_atlas.clone(),
            indices: animation_indices_gabe.clone(),
        ...
        SpriteSheet {
            size: Vec2::new(120., 50.),
            text: "Fit Start".to_string(),
            transform: Transform3d::from_translation(Vec3::new(20., -300., 0.)),
            texture: gabe.clone(),
            image_mode: SpriteImageMode::Scale(ScalingMode::FitStart),
            atlas: gabe_atlas.clone(),
            indices: animation_indices_gabe.clone(),
        ...
        SpriteSheet {
            size: Vec2::new(120., 50.),
            text: "Fit End".to_string(),
            transform: Transform3d::from_translation(Vec3::new(160., -200., 0.)),
            texture: gabe.clone(),
            image_mode: SpriteImageMode::Scale(ScalingMode::FitEnd),
            atlas: gabe_atlas.clone(),
            indices: animation_indices_gabe.clone(),
    ...
    for sprite_sheet in sprite_sheets {
        ...
        cmd.with_children(|builder| {
            builder.spawn((
                ...
                TextLayout::new_with_justify(JustifyText::Center),
                TextFont::from_font_size(15.),
                Transform3d::from_xyz(0., -0.5 * sprite_sheet.size.y - 10., 0.),
                bevy::sprite::Anchor::TOP_CENTER,
            ));
        });
    }
