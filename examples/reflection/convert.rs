//! Illustrates how to do reflection with conversions
...
/// all fields also implement Reflect.
///
/// All fields in a reflected item will need to be `Reflect` as well. You can specify additional
/// types that will be accepted per field using `#[reflect(from(...))]`
#[derive(Reflect)]
pub struct Foo {
