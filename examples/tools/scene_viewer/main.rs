    ...
    if scene_handle.is_loaded && !*setup {
        *setup = true;
        ...
        commands.spawn((
            ...
            EnvironmentMapLight {
                diffuse_map: asset_server.load("assets/environment_maps/pisa_diffuse_zstd.ktx2"),
                specular_map: asset_server.load("assets/environment_maps/pisa_specular_zstd.ktx2"),
            },
            camera_controller,
        ));
