...
const AVAILABLE_KEYS: [MorphKey; 56] = [
    ...
    MorphKey::new("left-shift-R", &[KeyCode::ShiftLeft], KeyCode::KeyR),
    MorphKey::new("left-shift-T", &[KeyCode::ShiftLeft], KeyCode::KeyT),
    MorphKey::new("left-shift-Z", &[KeyCode::ShiftLeft], KeyCode::KeyZ),
    MorphKey::new("left-shift-I", &[KeyCode::ShiftLeft], KeyCode::KeyI),
    MorphKey::new("left-shift-O", &[KeyCode::ShiftLeft], KeyCode::KeyO),
    MorphKey::new("left-shift-P", &[KeyCode::ShiftLeft], KeyCode::KeyP),
    MorphKey::new("left-shift-F", &[KeyCode::ShiftLeft], KeyCode::KeyF),
    MorphKey::new("left-shift-G", &[KeyCode::ShiftLeft], KeyCode::KeyG),
    MorphKey::new("left-shift-H", &[KeyCode::ShiftLeft], KeyCode::KeyH),
    MorphKey::new("left-shift-J", &[KeyCode::ShiftLeft], KeyCode::KeyJ),
    MorphKey::new("left-shift-K", &[KeyCode::ShiftLeft], KeyCode::KeyK),
    MorphKey::new("left-shift-Y", &[KeyCode::ShiftLeft], KeyCode::KeyY),
    MorphKey::new("left-shift-X", &[KeyCode::ShiftLeft], KeyCode::KeyX),
    MorphKey::new("left-shift-C", &[KeyCode::ShiftLeft], KeyCode::KeyC),
    MorphKey::new("left-shift-V", &[KeyCode::ShiftLeft], KeyCode::KeyV),
    MorphKey::new("left-shift-B", &[KeyCode::ShiftLeft], KeyCode::KeyB),
    MorphKey::new("left-shift-N", &[KeyCode::ShiftLeft], KeyCode::KeyN),
    MorphKey::new("left-shift-M", &[KeyCode::ShiftLeft], KeyCode::KeyM),
    MorphKey::new("left-shift-0", &[KeyCode::ShiftLeft], KeyCode::Digit0),
    MorphKey::new("left-shift-1", &[KeyCode::ShiftLeft], KeyCode::Digit1),
    MorphKey::new("left-shift-2", &[KeyCode::ShiftLeft], KeyCode::Digit2),
    MorphKey::new("left-shift-3", &[KeyCode::ShiftLeft], KeyCode::Digit3),
    MorphKey::new("left-shift-4", &[KeyCode::ShiftLeft], KeyCode::Digit4),
    MorphKey::new("left-shift-5", &[KeyCode::ShiftLeft], KeyCode::Digit5),
    MorphKey::new("left-shift-6", &[KeyCode::ShiftLeft], KeyCode::Digit6),
    MorphKey::new("left-shift-7", &[KeyCode::ShiftLeft], KeyCode::Digit7),
    MorphKey::new("left-shift-8", &[KeyCode::ShiftLeft], KeyCode::Digit8),
    MorphKey::new("left-shift-9", &[KeyCode::ShiftLeft], KeyCode::Digit9),
];
