...
fn setup(
    ...
    commands.spawn((
        ...
        MeshMaterial3dHandle(materials.add(Color::srgb(0.3, 0.15, 0.3))),
    ...
    commands.spawn((
        ...
        MeshMaterial3dHandle(materials.add(Color::srgb(0.3, 0.15, 0.9))),
        TargetSphere,
    ));
    ...
    commands.spawn((
        Mesh3d(meshes.add(Sphere::new(0.3))),
        MeshMaterial3dHandle(materials.add(Color::srgb(0.9, 0.3, 0.3))),
