...
fn toggle_ime(
    ...
    mut text: Query<&mut Text, With<UiKey>>,
) {
...
fn listen_ime_events(
    ...
    mut status_text: Query<&mut Text, With<UiKey>>,
    mut edit_text: Query<&mut Text, (Without<UiKey>, Without<Bubble>)>,
) {
...
fn listen_keyboard_input_events(
    ...
    mut edit_text: Query<(Entity, &mut Text), (Without<UiKey>, Without<Bubble>)>,
) {
    for event in events.iter() {
