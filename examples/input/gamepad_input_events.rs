...
fn gamepad_events(
    ...
    mut axis_changed_events: EventReader<'_, '_, GamepadAxisChangedEvent>,
    // Handles the continuous measure of how far a button has been pressed down, equivalent to `GamepadButtons::get`.
    mut button_changed_events: EventReader<'_, '_, GamepadButtonChangedEvent>,
    ...
    mut button_input_events: EventReader<'_, '_, GamepadButtonStateChangedEvent>,
) {
...
fn gamepad_ordered_events(mut gamepad_events: EventReader<'_, '_, GamepadEvent>) {
