    ...
    for i in 0..N_CARS {
        ...
        commands
            .spawn((
                ...
                MeshMaterial3dHandle(color.clone()),
    ...
    let mut spawn_with_offset = |offset: f32| {
        for i in 0..N_CONES {
            ...
            commands.spawn((
                ...
                MeshMaterial3dHandle(matl.clone()),
...
fn spawn_trees(
    ...
    let mut spawn_with_offset = |offset: f32| {
        for i in 0..N_TREES {
            ...
            commands.spawn((
                Mesh3d(sphere.clone()),
                MeshMaterial3dHandle(leaves.clone()),
                Transform::from_xyz(x, -0.3, z).with_scale(Vec3::splat(0.3)),
            ));
            commands.spawn((
                Mesh3d(capsule.clone()),
                MeshMaterial3dHandle(trunk.clone()),
