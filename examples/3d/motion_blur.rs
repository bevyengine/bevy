...
fn setup_scene(
    ...
    commands.spawn(PbrBundle {
        ...
        material: materials.add(StandardMaterial {
            unlit: true,
            base_color: LinearRgba::rgb(0.1, 0.6, 1.0).into(),
            ..default()
        }),
...
fn spawn_cars(
    ...
    let colors = [
        matl(LinearRgba::rgb(1.0, 0.0, 0.0).into()),
        matl(LinearRgba::rgb(1.0, 1.0, 0.0).into()),
        matl(LinearRgba::BLACK.into()),
        matl(LinearRgba::rgb(0.0, 0.0, 1.0).into()),
        matl(LinearRgba::rgb(0.0, 1.0, 0.0).into()),
        matl(LinearRgba::rgb(1.0, 0.0, 1.0).into()),
        matl(LinearRgba::rgb(0.5, 0.5, 0.0).into()),
        matl(LinearRgba::rgb(1.0, 0.5, 0.0).into()),
    ];
...
fn spawn_barriers(
    ...
    let matl = materials.add(StandardMaterial {
        base_color: Srgba::rgb_u8(255, 87, 51).into(),
        reflectance: 1.0,
        ..default()
    });
...
fn spawn_trees(
    ...
    let leaves: Handle<StandardMaterial> = materials.add(LinearRgba::rgb(0.0, 1.0, 0.0));
    let trunk: Handle<StandardMaterial> = materials.add(LinearRgba::rgb(0.4, 0.2, 0.2));
