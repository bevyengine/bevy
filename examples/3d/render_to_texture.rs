...
fn setup(
    ...
    let cube_handle = meshes.add(Mesh::from(primitives::Cuboid::from_size(Vec3::splat(4.0))));
    ...
    let cube_size = Vec3::splat(4.0);
    let cube_handle = meshes.add(Mesh::from(primitives::Cuboid::from_size(cube_size)));
