...
#[derive(Component)]
struct KeyboardControlsFlag(u8);
...
fn change_directional_lights_with_scattering<const N: u8>(
    mut commands: Commands,
    directional_lights: Query<(Entity, &KeyboardControlsFlag), With<DirectionalLight>>,
) {
