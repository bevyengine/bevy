...
fn setup(
    ...
    let plane_mesh = meshes.add(Plane3d::default().mesh_builder().size(2.0, 2.0).mesh());
    let cylinder_mesh = meshes.add(Cylinder::new(0.5, 2.0).mesh_builder().resolution(50).mesh());
