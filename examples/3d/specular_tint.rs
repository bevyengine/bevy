...
fn setup(
    ...
    commands
        .spawn(Camera3dBundle {
            transform: Transform::from_xyz(-2.0, 0.0, 3.5).looking_at(Vec3::ZERO, Vec3::Y),
            camera: Camera {
                hdr: true,
                ..default()
            },
    ...
    commands.spawn(PbrBundle {
        ...
        // Rotate 90° to put the pole on the top.
...
fn shift_hue(
    ...
    objects_with_materials: Query<&Handle<StandardMaterial>>,
    mut standard_materials: ResMut<Assets<StandardMaterial>>,
) {
...
impl AppStatus {
    ...
    fn create_text(&self) -> Text {
        ...
        Text::from_section(tint_map_help_text, TextStyle::default())
    }
}
    ...
    for material_handle in objects_with_materials.iter() {
        ...
        match app_status.tint_type {
            ...
            TintType::Map => {
                ...
                material.specular_texture = Some(app_assets.noise_texture.clone());
