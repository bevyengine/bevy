...
fn setup(
    ...
    commands.spawn((
        ...
        children![(
            ...
            children![
                (Text::new("Controls:\n")),
                (Text::new("R / Z - reset biases to default / zero\n")),
                (Text::new("L     - switch between directional and point lights [",)),
                (Text::new("DirectionalLight")),
                (Text::new("]\n")),
                (Text::new("F     - switch directional light filter methods [",)),
                (Text::new("Hardware2x2")),
                (Text::new("]\n")),
                (Text::new("1/2   - change point light depth bias [")),
                (Text::new("0.00")),
                (Text::new("]\n")),
                (Text::new("3/4   - change point light normal bias [")),
                (Text::new("0.0")),
                (Text::new("]\n")),
                (Text::new("5/6   - change direction light depth bias [")),
                (Text::new("0.00")),
                (Text::new("]\n")),
                (Text::new("7/8   - change direction light normal bias [",)),
                (Text::new("0.0")),
                (Text::new("]\n")),
                (Text::new(
