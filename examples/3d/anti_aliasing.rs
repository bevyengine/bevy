...
fn modify_aa(
    ...
    #[cfg(all(feature = "dlss", not(feature = "bevy_ci_testing")))] camera: Single<
        (
            Entity,
            Option<&mut Fxaa>,
            Option<&mut Smaa>,
        ...
        With<Camera>,
    >,
    #[cfg(any(not(feature = "dlss"), feature = "bevy_ci_testing"))] camera: Single<
        (
            Entity,
            Option<&mut Fxaa>,
            Option<&mut Smaa>,
        ...
        With<Camera>,
    >,
    #[cfg(all(feature = "dlss", not(feature = "bevy_ci_testing")))] dlss_supported: Option<
