...
fn setup(
    ...
    commands.spawn(PbrBundle {
        mesh: meshes.add(Mesh::from(primitives::Cuboid::new(5.0, 0.15, 5.0))),
        transform,
        material: materials.add(StandardMaterial {
    ...
    commands.spawn((
        PbrBundle {
            mesh: meshes.add(Mesh::from(primitives::Rectangle::new(2.0, 0.5))),
            transform,
            material: materials.add(StandardMaterial {
    ...
    commands.spawn((
        PbrBundle {
            mesh: meshes.add(Mesh::from(primitives::Cuboid::new(1.0, 1.0, 1.0))),
            material: materials.add(StandardMaterial {
    ...
    commands.spawn((
        PbrBundle {
            mesh: meshes.add(primitives::Sphere { radius: 0.5 }.mesh().uv(32, 18)),
            material: materials.add(StandardMaterial {
    ...
    commands
        ...
        .with_children(|builder| {
            builder.spawn(PbrBundle {
                mesh: meshes.add(primitives::Sphere { radius: 0.1 }.mesh().uv(32, 18)),
                material: materials.add(StandardMaterial {
    ...
    commands
        ...
        .with_children(|builder| {
            builder.spawn(PbrBundle {
                ...
                mesh: meshes.add(Mesh::from(primitives::Capsule::new(0.1, 0.125).mesh())),
                material: materials.add(StandardMaterial {
