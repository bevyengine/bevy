...
//!
//! `Assets<T>` is a way of processing and storing "asset"-like data. You "give" it data with the `.add` method and it gives you back a `Handle<T>`, this prevents storing duplicate copies of the same data and removes any assets from memory that we're no longer using.
//!
