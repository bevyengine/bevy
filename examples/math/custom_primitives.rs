...
/// A custom 2D heart primitive. The heart is made up of two circles centered at `Vec2::new(±radius,
/// 0.)` each with the same `radius`.
///
...
// options for extrusions you can just implement them for your 2D `MeshBuilder`.
trait HeartBuilder {
