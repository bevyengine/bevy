...
fn vertically_scrolling_list(font_handle: Handle<FontFace>) -> impl Bundle {
    (
        Node {
            flex_direction: FlexDirection::Column,
...
fn bidirectional_scrolling_list(font_handle: Handle<FontFace>) -> impl Bundle {
    (
        Node {
            flex_direction: FlexDirection::Column,
            justify_content: JustifyContent::Center,
...
fn nested_scrolling_list(font_handle: Handle<FontFace>) -> impl Bundle {
    (
        Node {
            flex_direction: FlexDirection::Column,
            justify_content: JustifyContent::Center,
