...
fn setup(mut commands: Commands, asset_server: Res<AssetServer>) {
    ...
    let slicer = TextureSlicer {
        // `numbered_slices.png` is 48 pixels square. `BorderRect::square(16.)` insets slicing line from each edge by 16 pixels, resulting in nine slices that are each 16 pixels square.
