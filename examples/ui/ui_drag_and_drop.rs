            ...
            for column in 0..COLUMNS {
                for row in 0..ROWS {
                    ...
                    parent
                        ...
                        .observe(move |on_over: On<PointerOver>, mut query: Query<(&mut BackgroundColor, &mut BorderColor)>| {
                        ...
                        .observe(move |on_out: On<PointerOut>, mut query: Query<(&mut BackgroundColor, &mut BorderColor)>| {
                        ...
                        .observe(|on_drag_start: On<PointerDragStart>, mut query: Query<(&mut Outline, &mut GlobalZIndex)>| {
                            if let Ok((mut outline, mut global_zindex, )) = query.get_mut(on_drag_start.event_target()) {
                                outline.color = Color::WHITE;
                                global_zindex.0 = 1;
                            }
                        })
                        .observe(|on_drag: On<PointerDrag>, mut query: Query<&mut UiTransform>| {
                        ...
                        .observe(move |on_drag_end: On<PointerDragEnd>, mut query: Query<(&mut UiTransform, &mut Outline, &mut GlobalZIndex)>| {
                        ...
                        .observe(|on_drag_drop: On<PointerDragDrop>, mut query: Query<&mut Node>| {
