    ...
    commands
        ...
        .with_children(|root| {
            root.spawn(NodeBundle {
                ...
                size_constraints: SizeConstraints::suggested(Val::Px(180.0), Val::Px(100.0)),
            ...
            .with_children(|parent| {
                ...
                parent.spawn(NodeBundle {
                    ...
                    size_constraints: SizeConstraints::suggested(Val::Px(100.0), Val::Px(50.0)),
                    ..default()
                });
                ...
                parent.spawn(NodeBundle {
                    ...
                    size_constraints: SizeConstraints::suggested(Val::Px(100.0), Val::Px(75.0)),
                    ..default()
                });
                ...
                parent.spawn(NodeBundle {
                    ...
                    size_constraints: SizeConstraints::suggested(Val::Px(100.0), Val::Px(60.0)),
                    ..default()
                });
                ...
                parent.spawn(NodeBundle {
                    ...
                    size_constraints: SizeConstraints::suggested(Val::Px(100.0), Val::Px(125.0)),
                    ..default()
                });
            });
        });
