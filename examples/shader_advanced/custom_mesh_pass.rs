...
fn main() {
    ...
    app.add_plugins((
        DefaultPlugins,
        MaterialPlugin::<ExtendedMaterial<StandardMaterial, OutlineExtention>>::default(),
...
struct OutlineExtention {
    #[uniform(100)]
    outline_color: LinearRgba,
}

impl MaterialExtension for OutlineExtention {
...
fn setup(
    ...
    mut materials: ResMut<Assets<ExtendedMaterial<StandardMaterial, OutlineExtention>>>,
) {
    // Cube
    commands.spawn((
