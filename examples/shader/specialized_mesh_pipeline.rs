...
use bevy::{
    ...
    render::{
        ...
        view::{self, ExtractedViews, RenderVisibleEntities, ViewTarget, VisibilitySystems},
...
fn queue_custom_mesh_pipeline(
    ...
    views: Query<(Entity, &RenderVisibleEntities, &ExtractedViews, &Msaa), With<ExtractedViews>>,
