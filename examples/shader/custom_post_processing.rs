...
//! To adapt this example for 2D, replace all instances of 3D structures (such as `Core3D`, etc.)
//! with their corresponding 2D counterparts.
//!
    ...
    fn from_world(world: &mut World) -> Self {
        ...
        let pipeline_id = world
            ...
            .queue_render_pipeline(RenderPipelineDescriptor {
                ...
                // implemented because not all fields can have a default value.
