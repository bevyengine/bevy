...
fn setup(
    ...
    commands.spawn((
        ...
        MeshMaterial3dHandle(std_materials.add(Color::srgb(0.3, 0.5, 0.3))),
    ));
    ...
    commands.spawn((
        ...
        MeshMaterial3dHandle(depth_materials.add(PrepassOutputMaterial {
    ...
    commands.spawn((
        Mesh3d(meshes.add(Cuboid::default())),
        MeshMaterial3dHandle(std_materials.add(StandardMaterial {
...
fn toggle_prepass_view(
    ...
    material_handle: Query<&MeshMaterial3dHandle<PrepassOutputMaterial>>,
