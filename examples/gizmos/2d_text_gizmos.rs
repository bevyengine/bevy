    ...
    App::new()
        ...
        .add_systems(
            ...
            (
                draw_labels,
                draw_all_glyphs,
                draw_extended_glyphs,
                draw_unsupported_glyphs,
            ),
        )
        .run();
}
...
const UNSUPPORTED: &str = "UNSUPPORTED: はひふへほ";
...
fn draw_unsupported_glyphs(mut text_gizmos: Gizmos) {
    text_gizmos.text_2d(
        Isometry2d::from_xy(600., -600.),
        UNSUPPORTED,
        30.0,
        Vec2::ZERO,
        Color::WHITE,
