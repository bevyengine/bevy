...
[Single Line Text Input](ui/line_input.rs) | An example demonstrating a text input
[Multiple Text Inputs](ui/line_input.rs) | An example demonstrating multiple text inputs
