...
[Shadow Cubemap](../examples/3d/shadow_cubemap.rs) | A test of point light shadow cubemaps with a single point light in the center surrounded by text indicating the cubemap face. Use RenderDoc, Xcode, or similar tools to inspect the shadow map textures.
