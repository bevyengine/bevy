...
[Asset Settings](../examples/asset/asset_settings.rs) | Demonstrates the use of .meta files and AssetServer::load_with_settings to override settings when loading an asset
