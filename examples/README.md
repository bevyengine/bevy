...
[Sprite Z Order](../examples/2d/sprite_z_order.rs) | Visual check that a blended sprite moved by a key press keeps the correct draw order against a static one
