...
[Motion blur post processing shader](../examples/shader/post_processing_motion_blur.rs) | A shader that uses a storage texture to keep color data between frames.
