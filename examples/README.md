...
`cubemap` | [`3d/cubemap.rs`](./3d/cubemap.rs) | Demonstrates point light shadow cubemaps with a single point light in the center surrounded by text indicating the cubemap face.
