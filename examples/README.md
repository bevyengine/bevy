...
`log_diagnostics` | [`diagnostics/log_diagnostics.rs`](./diagnostics/log_diagnostics.rs) | Add a plugin that logs frames per second (FPS), frame time, and frame count diagnostics to the console
