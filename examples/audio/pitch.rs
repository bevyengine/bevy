...
fn play_pitch(mut pitch_assets: ResMut<Assets<Pitch>>, frequency: Res<PitchFrequency>, mut events: EventReader<PlayPitch>, mut commands: Commands) {
...
fn keyboard_input_system(keyboard_input: Res<Input<KeyCode>>, mut frequency: ResMut<PitchFrequency>, mut events: EventWriter<PlayPitch>) {
