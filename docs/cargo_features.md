...
|webgl2|Enable some limitations to be able to use WebGL2. If not enabled, it will default to WebGPU in Wasm. Please refer to the [WebGL2 and WebGPU](../examples/README.md) section of the examples README for more information on how to run Wasm builds with WebGPU.|
