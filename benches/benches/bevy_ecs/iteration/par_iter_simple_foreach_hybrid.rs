...
impl<'w> Benchmark<'w> {
    pub fn new() -> Self {
        ...
        // by shuffling ,randomize the archetype iteration order to significantly deviate from the
        // table order. This maximizes the loss of cache locality during archetype-based iteration.
