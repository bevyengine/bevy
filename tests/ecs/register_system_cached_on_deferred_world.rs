...
use bevy::{prelude::*, ecs::{system::SystemId, lifecycle::HookContext, world::DeferredWorld}};
...
fn main() {
    ...
    let first_system = world.entity(first_entity).get::<RegisteredSystem>().unwrap().0;
    let second_system = world.entity(second_entity).get::<RegisteredSystem>().unwrap().0;
...
impl ComponentWithOnAddHook {
    fn on_add(mut world: DeferredWorld, context: HookContext) {
        ...
        world.commands().entity(context.entity).insert(RegisteredSystem(system_id));
    }
