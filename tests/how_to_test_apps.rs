...
/// `Input::<KeyCode>`) need to be manually added, either directly or via e.g. [`InputPlugin`]. The
/// upside, however, is that the test has complete control over these resources, meaning we can fake
/// user input, fake the window being moved around, and more.
use bevy::prelude::*;
